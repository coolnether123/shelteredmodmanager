    ...
    internal static class ScenarioEventGraphInspectorBuilder
    {
            ...
            List<ScenarioAuthoringGraphEdgeViewModel> edges)
        {
            for (int i = 0; definition != null && definition.ScheduledActions != null && i < definition.ScheduledActions.Count; i++)
            {
                ...
                nodes.Add(GraphNode(
                    ...
                    status,
                    ScenarioInspectorItemFactory.Action(ScenarioAuthoringActionIds.ActionTimelineEntryPrefix + actionId, "Focus", "Focus this scheduled action on the timeline.", true, status != "OK", "EV")));
        ...
        private static void AddWinLossNodes(ScenarioDefinition definition, List<ScenarioAuthoringGraphNodeViewModel> nodes)
        {
            for (int i = 0; definition != null && definition.WinLossConditions != null && definition.WinLossConditions.WinConditions != null && i < definition.WinLossConditions.WinConditions.Count; i++)
            {
                ...
                nodes.Add(GraphNode("win:" + ScenarioInspectorItemFactory.Safe(condition != null ? condition.Id : null), ScenarioInspectorItemFactory.Safe(condition != null ? condition.Id : null), "Win Condition", condition != null ? condition.Type : "Unknown", "OK", null));
            }
            ...
            for (int i = 0; definition != null && definition.WinLossConditions != null && definition.WinLossConditions.LossConditions != null && i < definition.WinLossConditions.LossConditions.Count; i++)
            {
                ...
                nodes.Add(GraphNode("loss:" + ScenarioInspectorItemFactory.Safe(condition != null ? condition.Id : null), ScenarioInspectorItemFactory.Safe(condition != null ? condition.Id : null), "Loss Condition", condition != null ? condition.Type : "Unknown", "OK", null));
            }
        }
        ...
        private static bool IsEffectBroken(ScenarioDefinitionIndex index, ScenarioEffectDefinition effect)
        {
            if (effect == null)
                return true;
