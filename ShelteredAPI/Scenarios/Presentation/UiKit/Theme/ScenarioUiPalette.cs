...
namespace ShelteredAPI.Scenarios.Presentation.UiKit.Theme{
    ...
    internal sealed class ScenarioUiPalette : IScenarioUiPalette
    {
        ...
        public Color PanelRaised   { get { return new Color(0.37f, 0.33f, 0.29f, 1f); } }
        ...
        public Color BorderSubtle  { get { return new Color(0.43f, 0.35f, 0.25f, 0.78f); } }
        ...
        public Color AccentHover   { get { return new Color(0.48f, 0.42f, 0.35f, 1f); } }
        ...
        public Color AccentNeutral { get { return new Color(0.82f, 0.76f, 0.64f, 1f); } }
