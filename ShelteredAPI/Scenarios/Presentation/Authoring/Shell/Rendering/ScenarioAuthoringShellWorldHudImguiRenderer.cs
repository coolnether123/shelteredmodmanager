...
namespace ShelteredAPI.Scenarios.Presentation.Authoring.Shell
{
    internal sealed partial class ScenarioAuthoringShellImguiRenderModule
    {
        ...
        private bool TryResolvePlacementPointerAid(out string cell, out string footprint, out bool canPlace, out string reason)
        {
            ...
            {
                ScenarioBuildPlacementAuthoringService.StatusModel model = ScenarioBuildPlacementAuthoringService.Instance.GetStatusModel(
            ...
            {
                ScenarioSceneSpritePlacementAuthoringService.PointerAidModel model = ScenarioSceneSpritePlacementAuthoringService.Instance.GetPointerAidModel();
                if (model == null)
                    return false;
