    ...
    internal static class ScenarioCastWorkspaceActions
    {
        ...
        public static string StartingEntityId(ScenarioDefinition definition, int index)
        {
            ...
            return actorKey != null && CountStartingActorKeys(family, actorKey) == 1
                ? "starting.actor." + ScenarioAuthoringActionCodec.EncodeToken(actorKey)
        ...
        public static string FutureEntityId(ScenarioDefinition definition, int index)
        {
            ...
            return id != null && CountFutureIds(family, id) == 1
                ? "future.id." + ScenarioAuthoringActionCodec.EncodeToken(id)
        ...
        public static void SelectStartingDocument(ScenarioDefinition definition, int index)
        {
            SelectDocument(StartingEntityId(definition, index));
        }

        public static void SelectFutureDocument(ScenarioDefinition definition, int index)
        {
            SelectDocument(FutureEntityId(definition, index));
        }

        public static void SelectOverview()
        {
            SelectDocument(null);
        }

        private static void SelectDocument(string entityId)
        {
            ScenarioAuthoringRendererInteractionState state = ScenarioAuthoringRendererInteractionState.Instance;
            state.SetWorkspaceSelection(WorkspaceId, SubtabId, entityId);
            state.SetWorkspaceNarrowPane(WorkspaceId, SubtabId, true);
        }
    ...
    internal sealed class ScenarioCastWorkspaceViewModelBuilder
    {
            ...
            ScenarioAuthoringRendererInteractionState state)
        {
            ...
            return new ScenarioAuthoringNavigatorGroupViewModel
            {
                ...
                CreateAction = ScenarioInspectorItemFactory.Action(ScenarioAuthoringActionIds.ActionStartingSurvivorAdd, "Add Survivor", "Create and select a starting survivor.", true, missing, "S+"),
                StatusChips = new[]
                {
                    Chip(
            ...
            ScenarioAuthoringRendererInteractionState state)
        {
            ...
            return new ScenarioAuthoringNavigatorGroupViewModel
            {
                ...
                CreateAction = ScenarioInspectorItemFactory.Action(ScenarioAuthoringActionIds.ActionFutureSurvivorAdd, "Add Arrival", "Create and select a scheduled survivor arrival.", true, !hasFutureArrivals, "F+"),
        ...
        {
            bool hasStarting = ScenarioPlayStartReadiness.HasStartingSurvivor(definition);
            ...
            document.Sections = new[]
            {
                new ScenarioAuthoringInspectorSection
                {
                    ...
                    Items = new[]
                    {
                        ...
                        ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(ScenarioAuthoringActionIds.ActionStartingSurvivorAdd, "Add Starting Survivor", "Create a new starting survivor.", true, !hasStarting, "S+")),
                        ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(ScenarioAuthoringActionIds.ActionFutureSurvivorAdd, "Add Future Arrival", "Create a scheduled survivor arrival.", true, false, "F+"))
                    }
                },
                new ScenarioAuthoringInspectorSection
                {
