...
namespace ShelteredAPI.Scenarios.Presentation.Authoring.Shell
{
    internal static class ScenarioSuppliesWorkspaceActions
    {
        ...
        public static string PresetEntityId(int index)
        {
            ...
            return PresetPrefix + ScenarioAuthoringActionCodec.EncodeToken(id);
        }
        ...
        public static void SelectPresetDocument(int index)
        {
            ScenarioAuthoringRendererInteractionState state = ScenarioAuthoringRendererInteractionState.Instance;
            state.SetWorkspaceSubtab(WorkspaceId, SubtabId);
            state.SetWorkspaceSelection(WorkspaceId, SubtabId, PresetEntityId(index));
    ...
    internal sealed class ScenarioSuppliesWorkspaceViewModelBuilder
    {
        ...
        private static ScenarioAuthoringInspectorAction Action(
            ...
            string iconText)
        {
            return ScenarioAuthoringPresentationUtilities.Action(id, label, tooltip, enabled, emphasized, iconText);
        }
        ...
        private static ScenarioAuthoringInspectorAction Action(
            ...
            string detail)
        {
            return ScenarioAuthoringPresentationUtilities.Action(id, label, tooltip, enabled, emphasized, iconText, detail);
        }
        ...
        private static ScenarioAuthoringInspectorAction Action(
            ...
            string badge)
        {
            return ScenarioAuthoringPresentationUtilities.Action(id, label, tooltip, enabled, emphasized, iconText, detail, badge);
        }

        private static ScenarioAuthoringInspectorItem Text(string value)
        {
            return ScenarioAuthoringPresentationUtilities.Text(value);
        }

        private static ScenarioAuthoringInspectorItem Property(string label, string value)
        {
            return ScenarioAuthoringPresentationUtilities.Property(label, value);
        }

        private static ScenarioAuthoringInspectorItem ActionItem(ScenarioAuthoringInspectorAction action)
        {
            return ScenarioAuthoringPresentationUtilities.ActionItem(action);
        }
