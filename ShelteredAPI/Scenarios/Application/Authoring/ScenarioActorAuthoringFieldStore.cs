...
namespace ShelteredAPI.Scenarios.Application.Authoring
{
    ...
    {
        public const string FieldCommandPrefix = "mod_field.";
        ...
        public static bool IsProviderModLoaded(string modId)
        {
            ...
            {
                ScenarioActorAuthoringCapabilityRegistry shelteredRegistry = registry as ScenarioActorAuthoringCapabilityRegistry;
                if (shelteredRegistry != null && shelteredRegistry.HasProviderMod(modId))
                    return true;
