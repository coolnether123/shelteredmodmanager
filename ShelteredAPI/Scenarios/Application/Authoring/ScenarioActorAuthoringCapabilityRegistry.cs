...
{
    internal sealed class ScenarioActorAuthoringCapabilityRegistry : IActorAuthoringCapabilityRegistry
    {
        ...
        public bool RegisterProvider(IActorAuthoringCapabilityProvider provider)
        {
            ...
            MMLog.WriteDebug("[ScenarioActorAuthoring] Registered actor field provider '" + provider.ProviderId + "' from " + provider.ProviderModId + ".");
            return true;
        }
        ...
        public IList<ActorAuthoringFieldDefinition> GetFields(ActorKind actorKind)
        {
            ...
            for (int i = 0; providers != null && i < providers.Count; i++)
            {
                ...
                {
                    MMLog.WriteWarning("[ScenarioActorAuthoring] Provider '" + (provider != null ? provider.ProviderId : "<null>") + "' failed to list fields: " + ex.Message);
                }
