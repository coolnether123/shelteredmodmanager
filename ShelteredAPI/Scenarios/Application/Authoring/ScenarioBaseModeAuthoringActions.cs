...
namespace ShelteredAPI.Scenarios.Application.Authoring{
    internal static class ScenarioBaseModeAuthoringActions
    {
        ...
        public static string SwitchReload(ScenarioBaseGameMode baseMode)
        {
            return ActionSwitchReloadPrefix + ((int)baseMode).ToString(CultureInfo.InvariantCulture);
        }

        public static string SwitchOnly(ScenarioBaseGameMode baseMode)
        {
            return ActionSwitchOnlyPrefix + ((int)baseMode).ToString(CultureInfo.InvariantCulture);
        }
