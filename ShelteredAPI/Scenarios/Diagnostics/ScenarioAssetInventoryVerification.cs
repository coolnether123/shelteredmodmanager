...
namespace ShelteredAPI.Scenarios.Diagnostics
{
    internal static class ScenarioAssetInventoryVerification
    {
        public static void Verify(string root, ScenarioValidationResult result)
        {
            ...
            string scenarioPath = Path.Combine(packRoot, ScenarioDefinitionSerializer.DefaultFileName);
            ...
            ScenarioPackagePlan plan = new ScenarioPackagePlanner(adapter).Build(roundTrip, scenarioPath, exportRoot, true, new ScenarioValidationResult());
