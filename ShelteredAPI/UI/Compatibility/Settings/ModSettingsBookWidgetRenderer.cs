...
namespace ShelteredAPI.UI.Compatibility.Settings
{
    ...
    internal sealed class SliderThumbInteraction : MonoBehaviour
    {
        ...
        private void ApplyPointerValue()
        {
            ...
            Vector3 world = ResolvePointerWorld(CoordinateRoot);
        ...
        private static Vector3 ResolvePointerWorld(GameObject target)
        {
            Camera camera = UICamera.currentCamera;
            if (camera == null)
                camera = Camera.main;
            if (camera == null || target == null)
                return UICamera.lastHit.point;
