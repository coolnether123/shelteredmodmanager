...
namespace ShelteredScenarioEditor.Presentation.Authoring.Shell
{
    internal static class ScenarioCastPortraitResolver
    {
            ...
            out Color pants)
        {
            ...
            ShelteredScenarioRuntime.ResolveConfiguredAppearanceColors(appearance, out hair, out skin, out shirt, out pants);
        }
        ...
        {
            ShelteredScenarioRuntime.ResolveConfiguredAppearanceColors(null, out hair, out skin, out shirt, out pants);
        }
