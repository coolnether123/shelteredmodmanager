    ...
    internal sealed class ScenarioMapAuthoringContentBuilder : IScenarioAuthoringWindowContentBuilder
    {
        ...
        internal static ScenarioAuthoringInspectorSection BuildSupportedActionsSection(ScenarioAuthoringState state)
        {
            ...
            return new ScenarioAuthoringInspectorSection
            {
                ...
                {
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        mapActive ? MapAuthoringCommand.CloseMap() : MapAuthoringCommand.OpenMap(),
                        ...
                        mapActive ? "CL" : "MP")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        MapAuthoringCommand.SetMode(MapAuthoringModeKind.Select, null),
                        "Select",
                        ...
                        "SL")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        MapAuthoringCommand.SetMode(MapAuthoringModeKind.Move, null),
                        "Move",
                    ...
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        MapAuthoringCommand.SetMode(MapAuthoringModeKind.PaintTerrain, "Woodland"),
                        "Paint Trees",
                        ...
                        "TR")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        MapAuthoringCommand.SetMode(MapAuthoringModeKind.PaintTerrain, "Mountains"),
                        "Paint Mountains",
                        ...
                        "MT")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        MapAuthoringCommand.SetMode(MapAuthoringModeKind.PaintTerrain, "NowhereSpecial"),
                        "Clear Terrain",
                        ...
                        "ER")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        MapAuthoringCommand.SetMode(MapAuthoringModeKind.PaintTerrain, ShelteredAPI.Scenarios.Public.ShelteredScenarioAuthoring.GeneratedBlendTerrainId),
                        "Generated Blend",
                        ...
                        true,
                        state != null && state.MapAuthoringMode == "terrain:" + ShelteredAPI.Scenarios.Public.ShelteredScenarioAuthoring.GeneratedBlendTerrainId,
                        "GB")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        ShellUxCommand.HelpTopic(TutorialContent.TopicMap),
                        "Map Help",
                        ...
                        "HP")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        ShellUxCommand.SelectStage(ScenarioStageKind.Quests),
                        "Open Story",
        ...
        internal static ScenarioAuthoringInspectorSection BuildBrushOptionsSection(ScenarioAuthoringState state)
        {
            ...
            return new ScenarioAuthoringInspectorSection
            {
                ...
                Items = new[]
                {
                    ...
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(MapAuthoringCommand.SetBrushShape(MapTerrainBrushShape.Circle), "Round", "Use a round terrain brush.", true, shape == "circle", "O")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(MapAuthoringCommand.SetBrushShape(MapTerrainBrushShape.Rectangle), "Square", "Use a square terrain brush.", true, shape == "square", "[]")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(MapAuthoringCommand.SetBrushSize(1), "1 x 1", "Paint one map cell.", true, size == 1, "1")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(MapAuthoringCommand.SetBrushSize(3), "3 x 3", "Paint a small area.", true, size == 3, "3")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(MapAuthoringCommand.SetBrushSize(5), "5 x 5", "Paint a medium area.", true, size == 5, "5")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(MapAuthoringCommand.SetBrushSize(7), "7 x 7", "Paint a large area.", true, size == 7, "7"))
                }
            };
        }
        ...
        private static string FormatMapMode(string mode)
        {
            ...
            if (mode.StartsWith("terrain:", StringComparison.OrdinalIgnoreCase))
            {
                ...
                if (string.Equals(terrain, ShelteredAPI.Scenarios.Public.ShelteredScenarioAuthoring.GeneratedBlendTerrainId, StringComparison.OrdinalIgnoreCase)) return "Paint generated blend";
            }
