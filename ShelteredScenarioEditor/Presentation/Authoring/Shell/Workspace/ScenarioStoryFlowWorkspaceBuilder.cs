...
namespace ShelteredScenarioEditor.Presentation.Authoring.Shell
{
    internal sealed class ScenarioStoryFlowWorkspaceBuilder
    {
            ...
            ScenarioAuthoringWorkspaceViewModelFactory factory)
        {
            ...
            ScenarioStoryFlowIssue[] issues = ShelteredScenarioAuthoring.AnalyzeStoryFlow(definition);
            ...
            ScenarioAuthoringWorkspaceViewModelFactory factory)
        {
            ...
            ScenarioAuthoringNavigatorGroupViewModel stageGroup = new ScenarioAuthoringNavigatorGroupViewModel
            {
                ...
                CreateAction = ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.AddStage(), "Add Stage", "Create and select a new Story stage. Undo reverses it.", true, stages.Count == 0, "S+"),
                Rows = stages.ToArray()
            };
