...
namespace ShelteredScenarioEditor.Presentation.Authoring.Shell
{
    ...
    internal static class ScenarioMapWorkspaceVerification
    {
        ...
        public static void Verify(ScenarioValidationResult result)
        {
            ...
            ScenarioAuthoringWindowContentContext context = new ScenarioAuthoringWindowContentContext(null, null, null, definition, rendererState);
            ...
            Assert(overview != null && overview.Navigator != null && overview.Navigator.Groups != null
                    ...
                    && overview.Navigator.Groups[0].Rows[0].SelectAction.Command is MapAuthoringCommand
                    && ((MapAuthoringCommand)overview.Navigator.Groups[0].Rows[0].SelectAction.Command).Kind == MapAuthoringCommandKind.SelectLocation,
            ...
            Assert(overview != null && overview.Navigator != null && overview.Navigator.Groups != null
                    ...
                    && overview.Navigator.Groups[0].CreateAction.Command is MapAuthoringCommand
                    && ((MapAuthoringCommand)overview.Navigator.Groups[0].CreateAction.Command).Mode == MapAuthoringModeKind.Place,
            ...
            dispatcher.Register(new ScenarioMapAuthoringCommandHandler(null, null, null, null, null, null, rendererState));
            ScenarioCommandDispatchResult placement = dispatcher.DispatchDetailed(activeMapState, overview.Navigator.Groups[0].CreateAction.Command);
            Assert(placement.Handled && placement.Changed && string.Equals(activeMapState.MapAuthoringMode, "place", StringComparison.Ordinal),
            ...
            ScenarioMapWorkspaceSelection.SelectLocation(state, definition, location, rendererState);
            ...
            ScenarioAuthoringWindowContentContext statefulContext = new ScenarioAuthoringWindowContentContext(state, null, null, definition, rendererState);
            ...
            ScenarioMapWorkspaceSelection.ClearLocationSelection(state, rendererState);
        ...
        private static void VerifyLocationCreationCommandPath(ScenarioValidationResult result)
        {
            ...
            ScenarioMapWorkspaceViewModelBuilder builder = new ScenarioMapWorkspaceViewModelBuilder();
            ScenarioAuthoringWindowContentContext context = new ScenarioAuthoringWindowContentContext(state, session, null, definition, interaction);
            ...
            ScenarioAuthoringInspectorAction createAction = before != null && before.Navigator != null
                ...
                : null;
            ScenarioCommandDispatcher dispatcher = new ScenarioCommandDispatcher();
            dispatcher.Register(new ScenarioMapAuthoringCommandHandler(runtime, null, drafts, null, editor, new ScenarioAuthoringHistoryService(), interaction));

            ScenarioCommandDispatchResult arm = dispatcher.DispatchDetailed(state, createAction != null ? createAction.Command : null);
            MapAuthoringCommand worldClick = MapAuthoringCommand.ClickWorldPosition(125.5f, 240.25f);
            ScenarioCommandDispatchResult commit = dispatcher.DispatchDetailed(state, worldClick);

            Assert(arm.Handled && arm.Changed && commit.Handled && commit.Changed,
            ...
            ScenarioMapWorkspaceSelection.ClearLocationSelection(state, interaction);
        }
