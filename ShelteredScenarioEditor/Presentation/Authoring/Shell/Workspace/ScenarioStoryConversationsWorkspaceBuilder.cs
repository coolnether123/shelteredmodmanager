    ...
    internal sealed class ScenarioStoryConversationsWorkspaceBuilder
    {
            ...
            string search)
        {
            ...
            return new ScenarioAuthoringNavigatorGroupViewModel
            {
                ...
                CreateAction = create ? ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.AddConversation(), "Add Conversation", "Create and select a random conversation.", true, rows.Count == 0, "C+") : null,
            ...
            document.Sections = new[]
            {
                new ScenarioAuthoringInspectorSection
                {
                    ...
                    Items = new[]
                    {
                        ...
                        ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.AddConversation(), "Add Conversation", "Create a random authored conversation.", true, count == 0, "C+")),
                        ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.ToggleConversationSuppression(), "Suppress Vanilla Random Chatter", "Toggle vanilla random chatter while authored conversations are active.", true, authored != null && authored.Settings != null && authored.Settings.SuppressVanillaRandomChatter, "VN"))
                    }
                }
            };
            return document;
