            ...
            ScenarioAuthoringWorkspaceViewModelFactory factory)
        {
            ...
            navigator.Groups = new[]
            {
                new ScenarioAuthoringNavigatorGroupViewModel
                {
                    ...
                    CreateAction = ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.AddStoryCharacter(), "Add Character", "Create and select a Story character.", true, rows.Count == 0, "C+"),
            ...
            document.Sections = new[]
            {
                new ScenarioAuthoringInspectorSection
                {
                    ...
                    Items = new[]
                    {
                        ...
                        ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.AddStoryCharacter(), "Add Character", "Create a new Story character.", true, count == 0, "C+"))
                    }
                }
            };
            return document;
