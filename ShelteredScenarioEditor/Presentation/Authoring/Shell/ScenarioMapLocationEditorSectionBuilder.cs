    ...
    internal static class ScenarioMapLocationEditorSectionBuilder
    {
        public static ScenarioAuthoringInspectorSection Build(ScenarioAuthoringState state, ScenarioDefinition definition, MapAuthoringDefinition map)
        {
            ...
            else
            {
                ...
                items.Add(Editable("Name", location.DisplayName, MapLocationFieldKind.DisplayName, location.Id, "Shown on the expedition map."));
                items.Add(Editable("Kind / Category", location.Kind, MapLocationFieldKind.Kind, location.Id, "Maps to the vanilla map category and a known topography when possible."));
                items.Add(Editable("Icon Id", location.IconId, MapLocationFieldKind.IconId, location.Id, "Must match a known map icon sprite id."));
                items.Add(Action(ScenarioInspectorItemFactory.Action(
                    MapAuthoringCommand.CycleLocationIcon(location.Id),
                    "Next Icon",
                ...
                items.Add(Action(Toggle(location, MapLocationFieldKind.Searchable, "Searchable", location.Searchable)));
                items.Add(Editable("Danger", location.Danger.ToString(CultureInfo.InvariantCulture), MapLocationFieldKind.Danger, location.Id, "Fallback open-ground encounter chance."));
                items.Add(Action(Toggle(location, MapLocationFieldKind.VisibleAtStart, "Visible At Start", location.VisibleAtStart)));
                items.Add(Action(Toggle(location, MapLocationFieldKind.DiscoveredAtStart, "Discovered At Start", location.DiscoveredAtStart)));
                items.Add(Action(Toggle(location, MapLocationFieldKind.HiddenUntilDiscovered, "Hidden Until Discovery", location.HiddenUntilDiscovered)));
                ...
                items.Add(Editable("Loot Table", location.LootTableId, MapLocationFieldKind.LootTableId, location.Id, "References an authored loot table id."));
                items.Add(Action(Toggle(location, MapLocationFieldKind.ReplaceGeneratedLoot, "Replace Generated Loot", location.ReplaceGeneratedLoot)));
                AddLootPreview(items, definition, location);

                items.Add(Editable("Encounter Table", location.EncounterTableId, MapLocationFieldKind.EncounterTableId, location.Id, "References an authored encounter table id."));
                AddProjectionStatus(items);

                if (authored)
                {
                    items.Add(Action(ScenarioInspectorItemFactory.Action(
                        MapAuthoringCommand.BeginDuplicateLocation(location.Id),
            ...
            MapLocationDefinition location)
        {
            ...
            locationItems.Add(Editable("Name", location.DisplayName, MapLocationFieldKind.DisplayName, location.Id, "Shown on the expedition map."));
            locationItems.Add(Editable("Kind / Category", location.Kind, MapLocationFieldKind.Kind, location.Id, "Controls how the location behaves on the expedition map."));
            locationItems.Add(Editable("Danger", location.Danger.ToString(CultureInfo.InvariantCulture), MapLocationFieldKind.Danger, location.Id, "Fallback open-ground encounter chance."));
            locationItems.Add(Action(Toggle(location, MapLocationFieldKind.Searchable, "Searchable", location.Searchable)));
            locationItems.Add(Action(Toggle(location, MapLocationFieldKind.VisibleAtStart, "Visible At Start", location.VisibleAtStart)));
            locationItems.Add(Action(Toggle(location, MapLocationFieldKind.DiscoveredAtStart, "Discovered At Start", location.DiscoveredAtStart)));
            locationItems.Add(Action(Toggle(location, MapLocationFieldKind.HiddenUntilDiscovered, "Hidden Until Discovery", location.HiddenUntilDiscovered)));
            ...
            tableItems.Add(Action(Toggle(location, MapLocationFieldKind.ReplaceGeneratedLoot, "Replace Generated Loot", location.ReplaceGeneratedLoot)));
            ...
            advancedItems.Add(Editable("Icon ID", location.IconId, MapLocationFieldKind.IconId, location.Id, "Must match a known map icon sprite ID."));
            ...
            advancedItems.Add(Editable("Loot Table ID", location.LootTableId, MapLocationFieldKind.LootTableId, location.Id, "References an authored loot table ID."));
            advancedItems.Add(Editable("Encounter Table ID", location.EncounterTableId, MapLocationFieldKind.EncounterTableId, location.Id, "References an authored encounter table ID."));
        ...
        private static string FormatExact(List<ScenarioMapLootEntrySnapshot> entries)
        {
            ...
            {
                ScenarioMapLootEntrySnapshot entry = entries[i];
                if (entry != null)
        ...
        private static ScenarioAuthoringInspectorItem Editable(string label, string value, MapLocationFieldKind field, string id, string hint)
        {
            ...
            item.Action = ScenarioInspectorItemFactory.Action(
                MapAuthoringCommand.EditLocationField(field, id, null),
                label,
                hint,
                true,
                false,
        ...
        private static ScenarioAuthoringInspectorAction Toggle(MapLocationDefinition location, MapLocationFieldKind field, string label, bool value)
        {
            return ScenarioInspectorItemFactory.Action(
                MapAuthoringCommand.ToggleLocationField(field, location.Id),
                label,
