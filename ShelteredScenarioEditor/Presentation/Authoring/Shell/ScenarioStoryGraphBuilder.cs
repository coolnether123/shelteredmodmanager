...
namespace ShelteredScenarioEditor.Presentation.Authoring.Shell{
    ...
    ///   * <see cref="ShelteredScenarioAuthoring.AnalyzeStoryFlow"/> supplies problems, including
    ...
    internal static class ScenarioStoryGraphBuilder
    {
        ...
        public static ScenarioStoryGraphModel Build(ScenarioDefinition definition, ScenarioStoryFlowIssue[] issues)
        {
            ...
            if (issues == null)
                issues = ShelteredScenarioAuthoring.AnalyzeStoryFlow(definition);
            ...
            for (int i = 0; i < includedStages; i++)
            {
                ...
                FocusedStoryCommand navCommand = FocusedStoryCommand.OpenStage(i);
                ScenarioStoryGraphNode node = new ScenarioStoryGraphNode
                {
                    ...
                    NavigationAutomationId = navCommand.AutomationId,
