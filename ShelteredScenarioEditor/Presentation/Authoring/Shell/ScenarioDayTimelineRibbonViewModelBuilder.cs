...
namespace ShelteredScenarioEditor.Presentation.Authoring.Shell
{
    ...
    internal sealed class ScenarioDayTimelineRibbonViewModelBuilder
    {
        ...
        private static ScenarioAuthoringInspectorAction BuildDayHoverAction(int day, int markerCount, int chapterCount)
        {
            ...
            TimelineNavigationCommand command = TimelineNavigationCommand.SelectDay(day.ToString(CultureInfo.InvariantCulture));
        ...
        private static ScenarioAuthoringInspectorAction BuildAction(
            ...
            string summary)
        {
            TimelineNavigationCommand command = TimelineNavigationCommand.OpenEntry(entry.Id);
