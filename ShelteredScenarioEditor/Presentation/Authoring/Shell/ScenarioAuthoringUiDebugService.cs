...
namespace ShelteredScenarioEditor.Presentation.Authoring.Shell{
    internal sealed class ScenarioAuthoringUiDebugService
    {
        ...
        internal ScenarioAuthoringUiDebugService(ScenarioTargetClassifier targetClassifier)
        {
        ...
        private static ScenarioAuthoringTargetKind InferKind(GameObject gameObject, string path)
        {
            ...
            if (ScenarioRuntimeIdentityCatalog.TryGet(gameObject, out identity)
                && identity.Kind == ScenarioRuntimeIdentityKind.SceneSpritePlacement)
