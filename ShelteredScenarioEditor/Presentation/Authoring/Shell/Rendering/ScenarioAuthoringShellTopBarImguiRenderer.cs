    ...
    internal sealed partial class ScenarioAuthoringShellImguiRenderModule
    {
        ...
        private void DrawMeasuredStageTabs(Rect rect, ScenarioAuthoringShellViewModel shell, bool compact)
        {
            ...
            if (!overflow)
            {
                ...
                _rendererInteraction.TopBarMoreOpen = false;
                return;
            }
            ...
            {
                Id = RendererInteractionAutomationIds.ActionRendererTopBarMoreToggle,
                Command = RendererInteractionCommand.ForSimple(RendererInteractionCommandKind.ToggleTopBarMore, RendererInteractionAutomationIds.ActionRendererTopBarMoreToggle),
                Label = "More >",
