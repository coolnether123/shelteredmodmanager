...
namespace ShelteredScenarioEditor.Presentation.Authoring.Shell
{
    ...
    internal sealed partial class ScenarioAuthoringShellImguiRenderModule
    {
            ...
            ScenarioAuthoringShellWindowViewModel window)
        {
            ...
            bool narrowDocumentPane = _rendererInteraction.GetWorkspaceNarrowPane(
                workspace.Id,
                subtabId,
                defaultDocumentPane);
            ...
            ScenarioAuthoringNavigatorViewModel navigator)
        {
            ...
            {
                RendererInteractionCommand command = RendererInteractionCommand.ForWorkspace(
                    RendererInteractionCommandKind.SetWorkspaceSearch,
                    RendererInteractionAutomationIds.ActionRendererWorkspaceSearchSetPrefix,
                    workspace != null ? workspace.Id : null,
                    subtabId,
                    nextValue);
                ExecuteRendererCommand(command);
            }
        ...
        private void ExecuteWorkspaceAction(ScenarioAuthoringInspectorAction action)
        {
