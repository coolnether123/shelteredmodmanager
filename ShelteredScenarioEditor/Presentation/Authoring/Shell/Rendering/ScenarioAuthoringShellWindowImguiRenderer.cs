    ...
    internal sealed partial class ScenarioAuthoringShellImguiRenderModule
    {
        ...
        private Rect DrawPixelEditorWindow(Rect rect, ScenarioAuthoringShellWindowViewModel window)
        {
            ...
            if (editor != null && editor.AnimationPlaying && _snapshot != null)
                _spriteSwap.TickAnimationPreview(_snapshot.State);
        ...
        private void DrawPixelEditorAnimationGroup(ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth)
        {
            ...
            GUILayout.BeginHorizontal();
            DrawInlineAction(SpriteSwapCommand.StepAnimationFrame(-1), "<", false, 34f, "Previous frame.");
            GUILayout.Space(4f);
            DrawInlineAction(SpriteSwapCommand.ToggleAnimationPlayback(), editor.AnimationPlaying ? "Pause" : "Play", editor.AnimationPlaying, 62f, "Preview inside the editor.");
            GUILayout.Space(4f);
            DrawInlineAction(SpriteSwapCommand.StepAnimationFrame(1), ">", false, 34f, "Next frame.");
            GUILayout.EndHorizontal();
            GUILayout.Space(3f);
            DrawInlineAction(SpriteSwapCommand.ToggleAnimationWorldPlayback(), editor.AnimationPlayingInWorld ? "Stop World" : "Play In World", editor.AnimationPlayingInWorld, Math.Min(contentWidth, 118f), "Play the edited animation on the selected world asset.");
            GUILayout.Space(3f);
            GUILayout.BeginHorizontal();
            DrawInlineAction(SpriteSwapCommand.ToggleOnionSkin(), "Onion", editor.OnionSkin, 68f, "Ghost neighboring frames under the current frame.");
            GUILayout.Space(4f);
            DrawInlineAction(SpriteSwapCommand.ToggleOriginalComparison(), "Original", editor.CompareOriginal, 78f, "Toggle the original frame overlay.");
            GUILayout.EndHorizontal();
            GUILayout.Space(2f);
            ...
            {
                GUILayout.BeginHorizontal();
                DrawInlineAction(SpriteSwapCommand.RevertAnimationFrame(), "Revert Frame", false, Math.Max(104f, (contentWidth - 8f) * 0.5f), "Revert the current frame.");
                GUILayout.Space(8f);
                DrawInlineAction(SpriteSwapCommand.RevertAnimation(), "Revert Animation", false, Math.Max(126f, (contentWidth - 8f) * 0.5f), "Revert all edited frames.");
                GUILayout.EndHorizontal();
            }
        }
        ...
        private void DrawPixelEditorClipboardGroup(ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth)
        {
            ...
            GUILayout.BeginHorizontal();
            DrawInlineAction(SpriteSwapCommand.CopyPixels(), "COPY", false, buttonWidth, "Copy the selection, or the full sprite when nothing is selected. Ctrl+C", true);
            GUILayout.Space(6f);
            DrawInlineAction(SpriteSwapCommand.PastePixels(), "PASTE", editor.HasClipboard, buttonWidth, editor.HasClipboard ? "Paste the pixel clipboard into the canvas. Ctrl+V" : "Pixel clipboard is empty.", editor.HasClipboard);
            GUILayout.Space(6f);
            DrawInlineAction(SpriteSwapCommand.ClearSelection(), "CLEAR", editor.HasSelection, buttonWidth, editor.HasSelection ? "Clear the current pixel selection." : "There is no active selection.", editor.HasSelection);
            GUILayout.EndHorizontal();
            GUILayout.Space(2f);
            GUILayout.Label(
                editor.HasSelection
        ...
        private bool DrawPixelEditorGroupHeader(string key, string label, bool defaultExpanded)
        {
            ...
            if (DrawPlainButton(rect, new GUIContent(action.Label, action.Hint), expanded ? _activeButtonStyle : _buttonStyle, true))
            {
                ExecuteRendererCommand(RendererInteractionCommand.ForKey(
                    RendererInteractionCommandKind.ToggleDisclosure,
                    RendererInteractionAutomationIds.ActionRendererPixelGroupTogglePrefix,
                    key));
        ...
        {
            return _rendererInteraction.GetDisclosureExpanded(key, defaultExpanded);
        }
        ...
        private void DrawAnimationToolbar(ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth)
        {
            ...
            GUILayout.BeginHorizontal();
            DrawInlineAction(SpriteSwapCommand.StepAnimationFrame(-1), "<", false, 42f, "Previous frame.");
            GUILayout.Space(4f);
            DrawInlineAction(SpriteSwapCommand.ToggleAnimationPlayback(), editor.AnimationPlaying ? "Pause" : "Play", editor.AnimationPlaying, buttonWidth, "Preview at the source game timing.");
            GUILayout.Space(4f);
            DrawInlineAction(SpriteSwapCommand.StepAnimationFrame(1), ">", false, 42f, "Next frame.");
            GUILayout.EndHorizontal();
            GUILayout.Space(4f);
            GUILayout.BeginHorizontal();
            DrawInlineAction(SpriteSwapCommand.ToggleOnionSkin(), "Onion", editor.OnionSkin, buttonWidth, "Ghost neighboring frames under the current frame.");
            GUILayout.Space(4f);
            DrawInlineAction(SpriteSwapCommand.ToggleOriginalComparison(), "Original", editor.CompareOriginal, buttonWidth, "Toggle the original frame overlay.");
            GUILayout.Space(4f);
            DrawInlineAction(SpriteSwapCommand.RevertAnimationFrame(), "Revert", false, buttonWidth, "Revert the current frame.");
            GUILayout.EndHorizontal();
            GUILayout.Space(4f);
            DrawInlineAction(SpriteSwapCommand.RevertAnimation(), "Revert Animation", false, Math.Min(contentWidth, 180f), "Revert all edited frames.");
        }
        ...
        private void DrawAnimationTimeline(ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth)
        {
            ...
            for (int i = 0; editor.AnimationFrames != null && i < editor.AnimationFrames.Count; i++)
            {
                ...
                if (GUI.Button(frameRect, GUIContent.none, GUIStyle.none))
                    _backend.ExecuteCommand(SpriteSwapCommand.SelectAnimationFrame(i));
                GUILayout.Space(4f);
            }
            GUILayout.FlexibleSpace();
            int previous = editor.AnimationFrameIndex > 0 ? editor.AnimationFrameIndex - 1 : Math.Max(0, editor.AnimationFrameCount - 1);
            DrawInlineAction(SpriteSwapCommand.CopyAnimationFrame(previous), "Copy Prev", false, 92f, "Copy the previous frame into the current frame.");
            GUILayout.EndHorizontal();
        }
        ...
        private void DrawCustomEditorToolbar(ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth)
        {
            ...
            DrawPixelEditorToolCard(
                SpriteSwapCommand.SelectTool(SpriteEditorTool.Paint),
                "P",
                "Paint",
            ...
            GUILayout.Space(6f);
            DrawPixelEditorToolCard(
                SpriteSwapCommand.SelectTool(SpriteEditorTool.Pick),
                "I",
                "Pick",
            ...
            GUILayout.Space(6f);
            DrawPixelEditorToolCard(
                SpriteSwapCommand.SelectTool(SpriteEditorTool.Select),
                "S",
                "Select",
            ...
            string hint)
        {
            ...
            DrawButtonAnimationOverlay(rect, command != null ? command.AutomationId : string.Empty, true, hovered, pressed);
        }
        ...
        private void DrawCustomClipboardToolbar(ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth)
        {
            ...
            GUILayout.Space(4f);
            DrawInlineAction(
                SpriteSwapCommand.ClearSelection(),
                "Clear Sel",
                editor.HasSelection,
                buttonWidth,
        ...
        private void DrawCharacterPartToolbar(ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth)
        {
            ...
            GUILayout.BeginHorizontal();
            DrawInlineAction(
                SpriteSwapCommand.SelectCharacterPart(ScenarioEditorCharacterTexturePart.Head),
                "Head",
                editor.CharacterPart == ScenarioEditorCharacterTexturePart.Head,
                buttonWidth,
                "Edit the head texture for this family member.");
            GUILayout.Space(4f);
            DrawInlineAction(
                SpriteSwapCommand.SelectCharacterPart(ScenarioEditorCharacterTexturePart.Torso),
                "Torso",
                editor.CharacterPart == ScenarioEditorCharacterTexturePart.Torso,
                buttonWidth,
                "Edit the torso texture for this family member.");
            GUILayout.Space(4f);
            DrawInlineAction(
                SpriteSwapCommand.SelectCharacterPart(ScenarioEditorCharacterTexturePart.Legs),
                "Legs",
                editor.CharacterPart == ScenarioEditorCharacterTexturePart.Legs,
                buttonWidth,
        ...
        private void DrawBrushSwatch(Rect rect, Color color, bool active, int brushIndex)
        {
            ...
            {
                _backend.ExecuteCommand(SpriteSwapCommand.SelectPreset(brushIndex));
                if (Event.current != null)
                    Event.current.Use();
            }
        }

        private void DrawInlineAction(ScenarioAuthoringCommand command, string label, bool emphasized, float width, string hint, bool enabled = true)
        {
            ScenarioAuthoringInspectorAction action = new ScenarioAuthoringInspectorAction
            {
        ...
        private void DrawAnimationSpeedSlider(ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth)
        {
            ...
            _backend.ExecuteCommand(SpriteSwapCommand.SetAnimationSpeed(rounded));
            if (Event.current != null)
                Event.current.Use();
        }
        ...
        private void DrawColorSlider(string label, ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float contentWidth, int channel)
        {
            ...
            _backend.ExecuteCommand(SpriteSwapCommand.SetColor(updatedColor));
            if (Event.current != null)
                Event.current.Use();
        }
        ...
        private void DrawPixelCanvas(Rect rect, ScenarioSpriteSwapAuthoringService.CustomEditorModel editor, float displayZoom)
        {
            ...
            if (current != null && rect.Contains(current.mousePosition) && IsInteractiveVisualTopmost(rect))
            {
                ...
                SpriteSwapCommand command = null;
                if (current.button == 1)
                {
                    if (current.type == EventType.MouseDown || current.type == EventType.MouseDrag)
                        command = SpriteSwapCommand.PickPixel(pixelX, pixelY);
                }
                else if (editor.ActiveTool == ScenarioSpriteSwapAuthoringService.CustomEditorTool.Select)
                {
                    if (current.type == EventType.MouseDown)
                        command = SpriteSwapCommand.BeginSelection(pixelX, pixelY);
                    else if (current.type == EventType.MouseDrag)
                        command = SpriteSwapCommand.DragSelection(pixelX, pixelY);
                    else if (current.type == EventType.MouseUp)
                        command = SpriteSwapCommand.EndSelection(pixelX, pixelY);
                }
                else if (current.type == EventType.MouseDown || current.type == EventType.MouseDrag)
                {
                    if (current.type == EventType.MouseDown
                        && editor.ActiveTool == ScenarioSpriteSwapAuthoringService.CustomEditorTool.Paint)
                    {
                        _backend.ExecuteCommand(SpriteSwapCommand.BeginStroke());
                    }

                    command = editor.ActiveTool == ScenarioSpriteSwapAuthoringService.CustomEditorTool.Pick
                        ? SpriteSwapCommand.PickPixel(pixelX, pixelY)
                        : SpriteSwapCommand.PaintPixel(pixelX, pixelY);
                }
        ...
        private bool TryHandlePixelCanvasWheel(Rect rect, Event current)
        {
            ...
            _backend.ExecuteCommand(SpriteSwapCommand.Zoom(-deltaSign));
        ...
        {
            searchText = _rendererInteraction.GetCandidateSearch(controlName);
            candidateFilter = _rendererInteraction.GetCandidateFilter(controlName, CandidateFilterAll);
            ...
            {
                ExecuteRendererCommand(RendererInteractionCommand.ForControlValue(
                    RendererInteractionCommandKind.SetCandidateSearch,
                    RendererInteractionAutomationIds.ActionRendererCandidateSearchPrefix,
                    controlName,
                    nextSearchText));
                searchText = _rendererInteraction.GetCandidateSearch(controlName);
            }
        ...
        private void DrawCandidateFilterButton(string controlName, string label, string value, ref string candidateFilter)
        {
            ...
            {
                ExecuteRendererCommand(RendererInteractionCommand.ForControlValue(
                    RendererInteractionCommandKind.SetCandidateFilter,
                    RendererInteractionAutomationIds.ActionRendererCandidateFilterPrefix,
                    controlName,
                    value));
                candidateFilter = _rendererInteraction.GetCandidateFilter(controlName, CandidateFilterAll);
            }
        ...
        private void DrawHomeWorkshopPage(ScenarioAuthoringShellWindowViewModel window)
        {
            ...
            if (baseMode != null)
                DrawCollapsibleGroup(RendererInteractionAutomationIds.ActionRendererHomeGroupTogglePrefix, "home.group.base", "Scenario base", BuildBaseModeSummary(baseMode), false, baseMode, DisclosureBodyStrategy.HomeBase);
            if (details != null)
                DrawCollapsibleGroup(RendererInteractionAutomationIds.ActionRendererHomeGroupTogglePrefix, "home.group.details", "Scenario details", BuildDetailsSummary(details), false, details, DisclosureBodyStrategy.HomeDetails);
            if (status != null)
                DrawCollapsibleGroup(RendererInteractionAutomationIds.ActionRendererHomeGroupTogglePrefix, "home.group.status", "Save & export status", BuildStatusSummary(status), false, status, DisclosureBodyStrategy.HomeStatus);
            ...
            {
                GUILayout.Space(12f);
                DrawCollapsibleGroup(RendererInteractionAutomationIds.ActionRendererHomeGroupTogglePrefix, "home.group.advanced", "Advanced diagnostics", "Debug details", false, advanced, DisclosureBodyStrategy.Section);
            }
            GUILayout.EndVertical();
        ...
        {
            bool expanded = _rendererInteraction.GetDisclosureExpanded(key, defaultExpanded);
            ...
            if (DrawPlainButton(rect, new GUIContent(header, hint), expanded ? _activeButtonStyle : _buttonStyle, true))
            {
                ...
                if (Event.current != null)
                    Event.current.Use();
                expanded = _rendererInteraction.GetDisclosureExpanded(key, defaultExpanded);
            }
            DrawButtonAnimationOverlay(rect, key, true, IsInteractiveHoverAllowed(rect), IsInteractiveMouseDownAllowed(rect));
            if (expanded)
            {
        ...
        private void DrawTimelineWorkshopPage(ScenarioAuthoringShellWindowViewModel window)
        {
            ...
            if (logic != null)
            {
                ...
                DrawCollapsibleGroup(
                    RendererInteractionAutomationIds.ActionRendererTimelineGroupTogglePrefix,
            ...
            bool textures)
        {
            ...
            if (DrawPlainButton(headerRect, new GUIContent(label, expanded ? "Collapse " + title + "." : "Expand " + title + "."), expanded ? _activeButtonStyle : _buttonStyle, true))
            {
                ExecuteRendererCommand(RendererInteractionCommand.ForKey(
                    RendererInteractionCommandKind.ToggleDisclosure,
                    RendererInteractionAutomationIds.ActionRendererWorkshopGroupTogglePrefix,
                    key));
                if (Event.current != null)
                    Event.current.Use();
                expanded = _rendererInteraction.GetDisclosureExpanded(key, defaultExpanded);
        ...
        private void DrawSurvivorColorRow(Rect rect, ScenarioSurvivorColorRowViewModel row)
        {
            ...
            RegisterTourTarget("action:" + (row.OpenColorPickerCommand != null ? row.OpenColorPickerCommand.AutomationId : string.Empty), swatchRect);
            if (DrawPlainButton(swatchRect, GUIContent.none, GUIStyle.none, true))
                _backend.ExecuteCommand(row.OpenColorPickerCommand);
        ...
        private void DrawModFieldRow(ScenarioSurvivorModFieldRowViewModel row)
        {
            ...
            if (row.Kind == ScenarioSurvivorModFieldControlKind.Color && row.ColorRow != null)
            {
                ...
                RegisterTourTarget("action:" + (row.ColorRow.OpenColorPickerCommand != null ? row.ColorRow.OpenColorPickerCommand.AutomationId : string.Empty), swatchRect);
                if (DrawPlainButton(swatchRect, GUIContent.none, GUIStyle.none, true))
                    _backend.ExecuteCommand(row.ColorRow.OpenColorPickerCommand);
        ...
        private bool IsHomeAdvancedDetailsEnabled()
        {
            return _snapshot != null
                ...
                && _snapshot.State.Settings.ShowAdvancedDetails;
        }
        ...
        {
            return action != null
                && action.Command is SelectionCommand
                && (((SelectionCommand)action.Command).Kind == SelectionCommandKind.CycleStack
                    || ((SelectionCommand)action.Command).Kind == SelectionCommandKind.ToggleStack
                    || ((SelectionCommand)action.Command).Kind == SelectionCommandKind.SelectStackIndex);
        }
        ...
        private void TryCommitEditableField(
            ...
            bool focused)
        {
            if (item == null || item.Action == null || (item.Action.Command == null && string.IsNullOrEmpty(item.Action.Id)))
                return;
            ...
            if (!string.Equals(next, current, StringComparison.Ordinal))
                ExecuteInspectorTextAction(item.Action, next);
        ...
        {
            string sourceActionId = ScenarioAssetBrowserUx.GetSourceAutomationId(action);
            Event current = Event.current;
            ...
            ExecuteRendererCommand(RendererInteractionCommand.ForKey(
                RendererInteractionCommandKind.ToggleAssetFavorite,
                RendererInteractionAutomationIds.ActionRendererAssetFavoriteTogglePrefix,
                sourceActionId));
            current.Use();
            return true;
        }
        ...
        private void ExecuteCandidateCardAction(ScenarioAuthoringInspectorAction action, bool armPlacementOnAssetBrowserClick)
        {
            ...
            if (armPlacementOnAssetBrowserClick
                && action.Command is AssetBrowserCommand
                && ((AssetBrowserCommand)action.Command).Kind == AssetBrowserCommandKind.Select)
            {
                _backend.ExecuteCommand(AssetBrowserCommand.PlaceSelected());
            }
        }
        ...
        private void DrawCastCard(Rect rect, ScenarioCastCardViewModel card)
        {
            ...
            {
                ExecuteInspectorAction(primary);
                evt.Use();
            }
        }
            ...
            ScenarioAuthoringShellWindowViewModel window)
        {
            ...
            for (int column = 0; column < 2; column++)
            {
                ...
                for (int i = start; i < end; i++)
                {
                    ...
                    bool expanded = _rendererInteraction.GetDisclosureExpanded(key, roomy && i == start);
                    ...
                    if (DrawPlainButton(header, new GUIContent(label), expanded ? _activeButtonStyle : _buttonStyle, true))
                    {
                        ...
                        expanded = _rendererInteraction.GetDisclosureExpanded(key, roomy && i == start);
                    }
                    if (expanded)
                    {
                        GUILayout.BeginVertical(_uiContext.Styles.Section);
        ...
        private void DrawSettingItem(ScenarioAuthoringSettingsItemViewModel item)
        {
            ...
            {
                ShellUxCommand toggleCommand = ShellUxCommand.SettingToggle(item.Id);
            ...
            {
                ShellUxCommand decreaseCommand = ShellUxCommand.SettingStep(item.Id, -1);
                DrawButton(GUILayoutUtility.GetRect(26f, 24f, GUILayout.Width(26f), GUILayout.Height(24f)),
                    new ScenarioAuthoringInspectorAction
                    {
                        Id = decreaseCommand.AutomationId,
                ...
                ShellUxCommand increaseCommand = ShellUxCommand.SettingStep(item.Id, 1);
                DrawButton(GUILayoutUtility.GetRect(26f, 24f, GUILayout.Width(26f), GUILayout.Height(24f)),
                    new ScenarioAuthoringInspectorAction
                    {
                        Id = increaseCommand.AutomationId,
        ...
        private void DrawSettingChoiceOptions(ScenarioAuthoringSettingsItemViewModel item, float availableWidth)
        {
            ...
            for (int i = 0; item.ChoiceValues != null && i < item.ChoiceValues.Length; i++)
            {
                ...
                ShellUxCommand selectCommand = ShellUxCommand.SettingChoice(item.Id, value);
                ScenarioAuthoringInspectorAction action = new ScenarioAuthoringInspectorAction
                {
                    Id = selectCommand.AutomationId,
