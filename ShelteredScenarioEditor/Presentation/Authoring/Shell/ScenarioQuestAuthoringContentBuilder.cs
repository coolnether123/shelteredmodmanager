...
namespace ShelteredScenarioEditor.Presentation.Authoring.Shell{
    internal sealed class ScenarioQuestAuthoringContentBuilder : IScenarioAuthoringWindowContentBuilder
    {
        ...
        public ScenarioAuthoringInspectorSection[] Build(ScenarioAuthoringWindowContentContext context)
        {
            ...
            ScenarioStoryFlowIssue[] storyIssues = ShelteredScenarioAuthoring.AnalyzeStoryFlow(definition);
            ...
            ScenarioAuthoringCompactChoiceViewModel mode = new ScenarioAuthoringCompactChoiceViewModel
            {
                ...
                Options = new[]
                {
                    CompactOption(
                        ...
                        "Scheduled",
                        !triggered,
                        GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.SetQuestStartMode, questIndex, value: "scheduled"),
                        "Start this popup at its scheduled day and time."),
                    CompactOption(
                        "quest_start_triggered_" + indexText,
                        "Triggered",
                        triggered,
                        GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.SetQuestStartMode, questIndex, value: "triggered"),
            ...
            int questIndex)
        {
            ...
            if (triggered)
            {
                ...
                items.Add(CompactChoiceItem(new ScenarioAuthoringCompactChoiceViewModel
                {
                    ...
                    Options = new[]
                    {
                        CompactOption("quest_trigger_previous_" + indexText, "Previous", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestTrigger, questIndex, -1), "Use the previous authored trigger."),
                        CompactOption("quest_trigger_next_" + indexText, "Next", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestTrigger, questIndex, 1), "Use the next authored trigger.")
                    }
                }));
            ...
            else
            {
                ...
                items.Add(CompactChoiceItem(new ScenarioAuthoringCompactChoiceViewModel
                {
                    ...
                    Options = new[]
                    {
                        CompactOption("quest_day_earlier_" + indexText, "Earlier", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestDay, questIndex, -1), "Move the popup one day earlier."),
                        CompactOption("quest_day_later_" + indexText, "Later", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestDay, questIndex, 1), "Move the popup one day later.")
                    }
                }));
                items.Add(CompactChoiceItem(new ScenarioAuthoringCompactChoiceViewModel
                {
                    ...
                    Options = new[]
                    {
                        CompactOption("quest_hour_earlier_" + indexText, "-1 hour", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestHour, questIndex, -1), "Move the popup one hour earlier."),
                        CompactOption("quest_hour_later_" + indexText, "+1 hour", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestHour, questIndex, 1), "Move the popup one hour later."),
                        CompactOption("quest_minute_earlier_" + indexText, "-15 min", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestMinute, questIndex, -15), "Move the popup fifteen minutes earlier."),
                        CompactOption("quest_minute_later_" + indexText, "+15 min", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestMinute, questIndex, 15), "Move the popup fifteen minutes later.")
                    }
                }));
            }
            ...
            QuestDef libraryQuest)
        {
            ...
            items.Add(CompactChoiceItem(new ScenarioAuthoringCompactChoiceViewModel
            {
                ...
                Options = new[]
                {
                    CompactOption("quest_source_previous_" + indexText, "Previous", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestId, questIndex, -1), "Use the previous quest from the library."),
                    CompactOption("quest_source_next_" + indexText, "Next", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestId, questIndex, 1), "Use the next quest from the library.")
                }
            }));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.SyncQuestTitle, questIndex),
                "Use Library Title",
                ...
                "NM")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.SyncQuestDescription, questIndex),
            ...
            items.Add(CompactChoiceItem(new ScenarioAuthoringCompactChoiceViewModel
            {
                ...
                Options = new[]
                {
                    CompactOption("quest_completion_previous_" + indexText, "Previous", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestCompletion, questIndex, -1), "Use the previous completion requirement."),
                    CompactOption("quest_completion_next_" + indexText, "Next", false, GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestCompletion, questIndex, 1), "Use the next completion requirement.")
                }
            }));
            ...
            QuestDef libraryQuest)
        {
            ...
            return new ScenarioAuthoringInspectorSection
            {
                ...
                Items = new[]
                {
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.SpawnQuestNow, questIndex), "Preview Popup", "Ask the running game to show this quest popup now.", libraryQuest != null, false, "PV")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.MoveQuest, questIndex, -1), "Move Earlier", "Move this popup earlier in the authored list.", questIndex > 0, false, "UP")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.MoveQuest, questIndex, 1), "Move Later", "Move this popup later in the authored list.", questIndex + 1 < count, false, "DN")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.DuplicateQuest, questIndex), "Duplicate", "Copy this authored popup and select the copy.", true, false, "CP")),
                    ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.DeleteQuest, questIndex), "Remove", "Remove this authored popup.", true, false, "RM"))
                }
            };
        }
            ...
            string hint)
        {
            return new ScenarioAuthoringCompactChoiceOptionViewModel
            {
                ...
                Label = label,
                Selected = selected,
                Action = ScenarioInspectorItemFactory.Action(command, label, hint, true, selected, null)
            };
        }
            ...
            int conversationIndex)
        {
            ...
            ScenarioConversationDefinition conversation = authored != null && authored.Conversations != null
                && conversationIndex >= 0 && conversationIndex < authored.Conversations.Count
            ...
            List<ScenarioAuthoringInspectorSection> sections = new List<ScenarioAuthoringInspectorSection>();
            AppendConversationParticipants(sections, definition, conversation, conversationIndex);
            if (sections.Count > 0)
                sections[0].Title = "PARTICIPANTS";
            ScenarioAuthoringInspectorSection lines = BuildConversationLinesSection(conversation, conversationIndex);
            lines.Title = "LINES";
            sections.Add(lines);

            ScenarioAuthoringInspectorSection triggering = BuildConversationWhenSection(conversation, conversationIndex);
            triggering.Title = "TRIGGERING";
            List<ScenarioAuthoringInspectorItem> triggerItems = new List<ScenarioAuthoringInspectorItem>();
            for (int i = 0; triggering.Items != null && i < triggering.Items.Length; i++)
            {
                ScenarioAuthoringInspectorItem item = triggering.Items[i];
                if (item == null || string.Equals(item.Label, "Event trigger id", StringComparison.OrdinalIgnoreCase))
                    continue;
                triggerItems.Add(item);
            }
            triggering.Items = triggerItems.ToArray();
            sections.Add(triggering);

            string indexText = conversationIndex.ToString(CultureInfo.InvariantCulture);
            List<ScenarioAuthoringInspectorItem> toolItems = new List<ScenarioAuthoringInspectorItem>();
            toolItems.Add(ScenarioInspectorItemFactory.Text(FormatConversationSummary(definition, conversation)));
            toolItems.Add(ScenarioInspectorItemFactory.Property("Validation", ValidateConversation(definition, conversation)));
            toolItems.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                StoryAuthoringCommands.PreviewConversation(conversationIndex),
                "Run Preview",
                "Play this conversation now if its participants resolve in the authoring world.",
                true,
                true,
                "PV")));
            ScenarioAuthoringInspectorSection footer = BuildConversationFooterSection(
                conversationIndex,
                authored != null && authored.Conversations != null ? authored.Conversations.Count : 0);
            for (int i = 0; footer.Items != null && i < footer.Items.Length; i++)
                toolItems.Add(footer.Items[i]);
            sections.Add(Section("story_conversation_tools_" + indexText, "PREVIEW / TOOLS", ScenarioAuthoringInspectorSectionLayout.ActionStrip, toolItems));

            List<ScenarioAuthoringInspectorItem> advancedItems = new List<ScenarioAuthoringInspectorItem>();
            advancedItems.Add(EditableProperty(
                "Internal conversation id",
                conversation.Id,
                StoryAuthoringCommands.SetConversationId(conversationIndex),
                "Stable routing id used by conversation effects."));
            advancedItems.Add(EditableProperty(
                "Event trigger key",
                conversation.Trigger != null ? conversation.Trigger.TriggerId : null,
                StoryAuthoringCommands.SetConversationTriggerId(conversationIndex),
                "Stored event routing key."));
            ScenarioConversationSuppressionDefinition settings = authored != null ? authored.Settings : null;
            advancedItems.Add(EditableProperty(
                "Suppressed topic keys",
                FormatList(settings != null ? settings.SuppressedVanillaTopicKeys : null),
                StoryAuthoringCommands.SetConversationSuppressionTopic(),
                "Stored vanilla localization topic keys."));
            for (int i = 0; conversation.Lines != null && i < conversation.Lines.Count; i++)
            {
                ...
                if (line != null && !string.IsNullOrEmpty(line.TextKey))
                    advancedItems.Add(ScenarioInspectorItemFactory.Property("Technical line key " + (i + 1).ToString(CultureInfo.InvariantCulture), line.TextKey));
            }
            ScenarioAuthoringInspectorSection existingAdvanced = BuildConversationAdvancedSection(conversation, conversationIndex);
            for (int i = 0; existingAdvanced.Items != null && i < existingAdvanced.Items.Length; i++)
                advancedItems.Add(existingAdvanced.Items[i]);
            ScenarioAuthoringInspectorSection advanced = Section(
                "story_conversation_advanced_" + indexText,
                "ADVANCED",
                ScenarioAuthoringInspectorSectionLayout.FactGrid,
                advancedItems);
        ...
        private static ScenarioAuthoringInspectorSection BuildStageFlowSection(ScenarioDefinition definition, ScenarioStoryFlowIssue[] storyIssues)
        {
            ...
            if (flow == null || flow.Stages == null || flow.Stages.Count == 0)
            {
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.AddStage(), "Add First Stage", "Create and select the first Story stage.", true, true, "S+")));
            }
            else
            {
                for (int i = 0; i < flow.Stages.Count; i++)
                {
                    ...
                    items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        FocusedStoryCommand.OpenStage(i),
        ...
        private static ScenarioAuthoringInspectorSection BuildStoryToolsSection(ScenarioDefinition definition)
        {
            List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                StoryAuthoringCommands.AddStage(),
                "Add Stage",
        ...
        private static ScenarioAuthoringInspectorSection BuildConversationOverviewSection(List<ScenarioConversationDefinition> authored, ScenarioConversationSuppressionDefinition settings)
        {
            ...
            List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                StoryAuthoringCommands.AddConversation(),
                "Add Conversation",
                ...
                "C+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                StoryAuthoringCommands.ToggleConversationSuppression(),
        ...
        private static void AppendConversation(List<ScenarioAuthoringInspectorSection> sections, ScenarioDefinition definition, ScenarioConversationDefinition conversation, int index, int count)
        {
            ...
            items.Add(EditableProperty("Technical conversation id", conversation != null ? conversation.Id : null, StoryAuthoringCommands.SetConversationId(index), "Stable id used by StartConversation effects."));
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.PreviewConversation(index), "Run Preview", "Play this conversation now if live members resolve in the authoring world.", true, false, "PV")));
        ...
        private static ScenarioAuthoringInspectorSection BuildConversationWhenSection(ScenarioConversationDefinition conversation, int index)
        {
            ...
            AddConversationTriggerActions(items, conversation != null ? conversation.Trigger : null, index);
        ...
        private static ScenarioAuthoringInspectorSection BuildConversationFooterSection(int index, int count)
        {
            string indexText = index.ToString(CultureInfo.InvariantCulture);
            List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.MoveConversation(index, -1), "Move Up", "Move this conversation earlier.", index > 0, false, "UP")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.MoveConversation(index, 1), "Move Down", "Move this conversation later.", index + 1 < count, false, "DN")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.DuplicateConversation(index), "Duplicate", "Copy this conversation.", true, false, "CP")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.DeleteConversation(index), "Remove", "Remove this conversation.", true, false, "RM")));
        ...
        private static void AppendConversationParticipants(List<ScenarioAuthoringInspectorSection> sections, ScenarioDefinition definition, ScenarioConversationDefinition conversation, int conversationIndex)
        {
            ...
            List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.AddConversationParticipant(conversationIndex), "Add Participant", "Add another participant slot.", true, false, "P+")));
            ...
            for (int i = 0; conversation != null && conversation.Participants != null && i < conversation.Participants.Count; i++)
            {
                ...
                sections.Add(ScenarioCastMemberPickerBuilder.BuildSection(
                    ...
                    candidate => StoryAuthoringCommands.SetConversationParticipantActor(conversationIndex, i, candidate.Token),
        ...
        private static void AddParticipantItems(List<ScenarioAuthoringInspectorItem> items, ScenarioDefinition definition, ScenarioConversationDefinition conversation, int conversationIndex, int participantIndex)
        {
            ...
            items.Add(EditableProperty("Slot " + (participantIndex + 1).ToString(CultureInfo.InvariantCulture), participant != null ? participant.Slot : null, StoryAuthoringCommands.SetConversationParticipantSlot(conversationIndex, participantIndex), "Speaker slot referenced by lines."));
            items.Add(ScenarioInspectorItemFactory.Property("Binding " + Safe(participant != null ? participant.Slot : null), FormatParticipant(definition, participant)));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.ToggleConversationParticipantRequired(conversationIndex, participantIndex), "Required", "Toggle whether unresolved participant blocks playback.", true, participant != null && participant.Required, "RQ")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.DeleteConversationParticipant(conversationIndex, participantIndex), "Remove Slot", "Remove this participant slot.", true, false, "RM")));

            AddStoryCharacterChoices(items, definition, participant, conversationIndex, participantIndex);
            AddFallbackChoices(items, participant, conversationIndex, participantIndex);
        }
        ...
        private static ScenarioAuthoringInspectorSection BuildConversationLinesSection(ScenarioConversationDefinition conversation, int conversationIndex)
        {
            string conversationText = conversationIndex.ToString(CultureInfo.InvariantCulture);
            List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.AddConversationLine(conversationIndex), "Add Line", "Add a timed speech-bubble line.", true, false, "L+")));
        ...
        private static void AddLineItems(List<ScenarioAuthoringInspectorItem> items, ScenarioConversationDefinition conversation, int conversationIndex, int lineIndex)
        {
            ...
            items.Add(ScenarioInspectorItemFactory.Property("Line " + (lineIndex + 1).ToString(CultureInfo.InvariantCulture), ResolveConversationLine(line, lineIndex), "Speaker " + Safe(line != null ? line.SpeakerSlot : null) + ", delay " + (line != null ? line.DelaySeconds.ToString("0.##", CultureInfo.InvariantCulture) : "0") + "s"));
            items.Add(EditableProperty("Text " + (lineIndex + 1).ToString(CultureInfo.InvariantCulture), line != null ? line.RawText : null, StoryAuthoringCommands.SetConversationLineText(conversationIndex, lineIndex), "Raw authored text shown in the speech bubble."));
            for (int i = 0; conversation.Participants != null && i < conversation.Participants.Count; i++)
            {
                ...
                {
                    items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        StoryAuthoringCommands.SetConversationLineSpeaker(conversationIndex, lineIndex, slot),
                        "Speaker " + slot,
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.SetConversationLineDelay(conversationIndex, lineIndex, 1f), "Delay +1s", "Increase delay before this line.", true, false, "D+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.SetConversationLineDelay(conversationIndex, lineIndex, -1f), "Delay -1s", "Decrease delay before this line.", true, false, "D-")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.DeleteConversationLine(conversationIndex, lineIndex), "Remove Line", "Remove this line.", true, false, "RM")));
        }

        private static void AddConversationTriggerActions(List<ScenarioAuthoringInspectorItem> items, ScenarioConversationTriggerDefinition trigger, int conversationIndex)
        {
            ...
            AddTriggerSource(items, trigger, conversationIndex, ScenarioConversationTriggerSource.Random);
            AddTriggerSource(items, trigger, conversationIndex, ScenarioConversationTriggerSource.Event);
            AddTriggerSource(items, trigger, conversationIndex, ScenarioConversationTriggerSource.Timeline);
            items.Add(EditableProperty("Event trigger id", trigger != null ? trigger.TriggerId : null, StoryAuthoringCommands.SetConversationTriggerId(conversationIndex), "For Event conversations, match an authored trigger id."));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.SetConversationTriggerWeight(conversationIndex, 0.5f), "Weight +", "Increase random pool weight.", true, false, "W+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.SetConversationTriggerWeight(conversationIndex, -0.5f), "Weight -", "Decrease random pool weight.", true, false, "W-")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StepConversationTriggerCooldown(conversationIndex, 1), "Cooldown +", "Increase random cooldown by one day.", true, false, "C+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StepConversationTriggerCooldown(conversationIndex, -1), "Cooldown -", "Decrease random cooldown by one day.", true, false, "C-")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.ToggleConversationTriggerOnce(conversationIndex), "Once", "Run this conversation only once.", true, trigger != null && trigger.Once, "1X")));
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StepConversationTriggerDay(conversationIndex, 1), "Day +", "Move timeline one day later.", true, false, "D+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StepConversationTriggerDay(conversationIndex, -1), "Day -", "Move timeline one day earlier.", true, false, "D-")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StepConversationTriggerHour(conversationIndex, 1), "Hour +", "Move timeline one hour later.", true, false, "H+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StepConversationTriggerHour(conversationIndex, -1), "Hour -", "Move timeline one hour earlier.", true, false, "H-")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StepConversationTriggerMinute(conversationIndex, 15), "Min +15", "Move timeline fifteen minutes later.", true, false, "M+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StepConversationTriggerMinute(conversationIndex, -15), "Min -15", "Move timeline fifteen minutes earlier.", true, false, "M-")));
        }

        private static void AddTriggerSource(List<ScenarioAuthoringInspectorItem> items, ScenarioConversationTriggerDefinition trigger, int conversationIndex, ScenarioConversationTriggerSource source)
        {
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                StoryAuthoringCommands.SetConversationTriggerSource(conversationIndex, source.ToString()),
                source.ToString(),
        ...
        private static void AppendStoryStage(List<ScenarioAuthoringInspectorSection> sections, ScenarioDefinition definition, ScenarioFlowDefinition flow, ScenarioFlowStageDefinition stage, int index, List<string> characterIds, ScenarioStoryFlowIssue[] storyIssues)
        {
            ...
            string indexText = index.ToString(CultureInfo.InvariantCulture);
            List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(FocusedStoryCommand.OpenStage(index), "Open Stage", "Edit this stage in its Story document.", true, CountStageIssues(storyIssues, index) > 0, "ED")));
            ...
            for (int c = 0; characterIds != null && c < characterIds.Count; c++)
            {
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    StoryAuthoringCommands.StageCharacterToggle(index, id),
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageUnansweredDelay(index, 1), "Delay +", "Increase unanswered delay by one day.", true, false, "D+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageUnansweredDelay(index, -1), "Delay -", "Decrease unanswered delay by one day.", true, false, "D-")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StagePunish(index), "Punish Unanswered", "Toggle vanilla unanswered punishment.", true, stage.PunishOnUnanswered, "PU")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.IntercomAdd(index), "Add Step", "Add an intercom step to this stage.", true, false, "I+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageMove(index, -1), "Move Up", "Move this stage earlier.", index > 0, false, "UP")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageMove(index, 1), "Move Down", "Move this stage later.", index + 1 < flow.Stages.Count, false, "DN")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageDuplicate(index), "Duplicate", "Copy this stage.", true, false, "CP")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageDelete(index), "Remove", "Remove this stage.", true, false, "RM")));
        ...
        private static ScenarioAuthoringInspectorSection BuildIntercomSection(ScenarioDefinition definition, ScenarioFlowDefinition flow, ScenarioFlowStageDefinition stage, ScenarioIntercomStageDefinition intercom, int stageIndex, int intercomIndex, List<string> characterIds)
        {
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageChangeDelay(stageIndex, intercomIndex, 1), "Stage Delay +", "Increase stage-change delay.", true, false, "SD+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageChangeDelay(stageIndex, intercomIndex, -1), "Stage Delay -", "Decrease stage-change delay.", true, false, "SD-")));
            AddIntercomTypeActions(items, stageIndex, intercomIndex, intercom.Type);
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.DialogueAdd(stageIndex, intercomIndex), "Add Dialogue", "Add a dialogue key.", true, false, "D+")));
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.OptionAdd(stageIndex, intercomIndex), "Add Option", "Add a response option.", true, false, "O+")));
            ...
            for (int i = 0; characterIds != null && i < characterIds.Count; i++)
            {
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.RecruitToggle(stageIndex, intercomIndex, id), "Recruit " + FormatCharacterLabel(definition, id), "Toggle recruitment for this character.", true, selected, "RC")));
            }
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.RecruitFamily(stageIndex, intercomIndex), "Recruit As Family", "Toggle family recruitment.", true, intercom.RecruitAsFamily, "RF")));
            AddEndTypeActions(items, stageIndex, intercomIndex, intercom.EndOptions != null ? intercom.EndOptions.Type : null);
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.EndCompleteQuest(stageIndex, intercomIndex), "Complete Quest", "Toggle vanilla quest completion.", true, intercom.EndOptions != null && intercom.EndOptions.CompleteQuest, "CQ")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.EndCompleteScenario(stageIndex, intercomIndex), intercom.EndOptions != null && intercom.EndOptions.CompleteParentScenario ? "Clear Complete Scenario" : "Complete Scenario unavailable", "Use Victory conditions to complete the authored scenario.", intercom.EndOptions != null && intercom.EndOptions.CompleteParentScenario, false, "VC")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.IntercomMove(stageIndex, intercomIndex, -1), "Move Step Up", "Move this intercom step earlier.", intercomIndex > 0, false, "UP")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.IntercomMove(stageIndex, intercomIndex, 1), "Move Step Down", "Move this intercom step later.", intercomIndex + 1 < stage.IntercomStages.Count, false, "DN")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.IntercomDuplicate(stageIndex, intercomIndex), "Duplicate Step", "Copy this intercom step.", true, false, "CP")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.IntercomDelete(stageIndex, intercomIndex), "Remove Step", "Remove this intercom step.", true, false, "RM")));
        ...
        private static ScenarioAuthoringInspectorSection BuildToolsSection(QuestAuthoringSnapshot snapshot)
        {
            List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                GameplayScheduleCommands.AddQuest(),
                "Add Quest",
                ...
                "Q+")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                GameplayScheduleCommands.CaptureActiveQuests(),
                "Capture Active",
        ...
        private static ScenarioAuthoringInspectorSection BuildPickerSection(QuestAuthoringSnapshot snapshot)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < max; i++)
                {
                    ...
                    items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                        GameplayScheduleCommands.AddCatalogQuest(i),
        ...
        private static void AddStageIdActions(List<ScenarioAuthoringInspectorItem> items, ScenarioFlowDefinition flow, int index)
        {
            for (int i = 0; flow != null && flow.Stages != null && i < flow.Stages.Count; i++)
            {
                ...
                if (string.IsNullOrEmpty(id))
                    continue;
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    StoryAuthoringCommands.StageId(index, id + "_copy"),
                    "Id " + id + "_copy",
        ...
        {
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageUnanswered(index, null), "No Unanswered Route", "Clear unanswered stage routing.", true, string.IsNullOrEmpty(current), "UN")));
            for (int i = 0; flow != null && flow.Stages != null && i < flow.Stages.Count; i++)
            {
                string id = flow.Stages[i] != null ? flow.Stages[i].Id : null;
                if (string.IsNullOrEmpty(id))
                    continue;
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    StoryAuthoringCommands.StageUnanswered(index, id),
                    "Unanswered -> " + id,
        ...
        private static void AddIntercomIdActions(List<ScenarioAuthoringInspectorItem> items, ScenarioFlowStageDefinition stage, int stageIndex, int intercomIndex)
        {
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.IntercomId(stageIndex, intercomIndex, candidate), "Id " + candidate, "Rename using the next step-id pattern.", true, false, "ID")));
        }
        ...
        private static void AddIntercomTargetActions(List<ScenarioAuthoringInspectorItem> items, ScenarioFlowStageDefinition stage, ScenarioIntercomStageDefinition intercom, int stageIndex, int intercomIndex, bool alternate, string label)
        {
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(alternate ? StoryAuthoringCommands.IntercomAlternate(stageIndex, intercomIndex, null) : StoryAuthoringCommands.IntercomNext(stageIndex, intercomIndex, null), label + " None", "Clear this intercom route.", true, string.IsNullOrEmpty(current), label)));
            for (int i = 0; stage != null && stage.IntercomStages != null && i < stage.IntercomStages.Count; i++)
            {
                ...
                if (string.IsNullOrEmpty(id))
                    continue;
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(alternate ? StoryAuthoringCommands.IntercomAlternate(stageIndex, intercomIndex, id) : StoryAuthoringCommands.IntercomNext(stageIndex, intercomIndex, id), label + " -> " + id, "Route to this intercom step.", true, string.Equals(current, id, StringComparison.OrdinalIgnoreCase), label)));
            }
        }
        ...
        {
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageChangeTarget(stageIndex, intercomIndex, null), "No Stage Change", "Clear delayed stage transition.", true, string.IsNullOrEmpty(current), "SC")));
            for (int i = 0; flow != null && flow.Stages != null && i < flow.Stages.Count; i++)
            {
                string id = flow.Stages[i] != null ? flow.Stages[i].Id : null;
                if (string.IsNullOrEmpty(id))
                    continue;
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.StageChangeTarget(stageIndex, intercomIndex, id), "Stage -> " + id, "Change to this scenario stage.", true, string.Equals(current, id, StringComparison.OrdinalIgnoreCase), "SC")));
            }
        }
        ...
        private static void AddIntercomTypeActions(List<ScenarioAuthoringInspectorItem> items, int stageIndex, int intercomIndex, string current)
        {
            ...
            for (int i = 0; i < types.Length; i++)
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.IntercomType(stageIndex, intercomIndex, types[i]), types[i], "Set vanilla encounter branch type.", true, string.Equals(current, types[i], StringComparison.OrdinalIgnoreCase), "TY")));
        }
        ...
        private static void AddDialogueActions(List<ScenarioAuthoringInspectorItem> items, ScenarioDefinition definition, ScenarioFlowStageDefinition stage, ScenarioDialogueLineDefinition line, int stageIndex, int intercomIndex, int lineIndex)
        {
            ...
            for (int i = 0; i < speakers.Count; i++)
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.DialogueSpeaker(stageIndex, intercomIndex, lineIndex, speakers[i]), FormatCharacterLabel(definition, speakers[i]), "Set dialogue speaker.", true, line != null && string.Equals(line.Character, speakers[i], StringComparison.OrdinalIgnoreCase), "SP")));
            string key = line != null && !string.IsNullOrEmpty(line.TextKey) ? line.TextKey : "dialogue";
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.DialogueKey(stageIndex, intercomIndex, lineIndex, key + "_copy"), "Key " + key + "_copy", "Use the next localization-key pattern.", true, false, "KY")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.DialogueDelete(stageIndex, intercomIndex, lineIndex), "Remove Dialogue", "Remove this dialogue line.", true, false, "RM")));
        }
        ...
        private static void AddOptionActions(List<ScenarioAuthoringInspectorItem> items, ScenarioFlowStageDefinition stage, ScenarioDialogueOptionDefinition option, int stageIndex, int intercomIndex, int optionIndex)
        {
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.OptionKey(stageIndex, intercomIndex, optionIndex, key + "_copy"), "Key " + key + "_copy", "Use the next option-key pattern.", true, false, "KY")));
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.OptionNext(stageIndex, intercomIndex, optionIndex, null), "Next None", "Clear this option route.", true, option == null || string.IsNullOrEmpty(option.NextId), "NX")));
            for (int i = 0; stage != null && stage.IntercomStages != null && i < stage.IntercomStages.Count; i++)
            {
                string id = stage.IntercomStages[i] != null ? stage.IntercomStages[i].Id : null;
                if (string.IsNullOrEmpty(id))
                    continue;
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.OptionNext(stageIndex, intercomIndex, optionIndex, id), "Option -> " + id, "Route this option to an intercom step.", true, option != null && string.Equals(option.NextId, id, StringComparison.OrdinalIgnoreCase), "NX")));
            }
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.OptionDelete(stageIndex, intercomIndex, optionIndex), "Remove Option", "Remove this response option.", true, false, "RM")));
        }
        ...
        {
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.RandomRouteAdd(stageIndex, intercomIndex), "Add Random Route", "Add a randomized next-step candidate.", true, false, "R+")));
            for (int r = 0; intercom.RandomizedNextIds != null && r < intercom.RandomizedNextIds.Count; r++)
            {
                ...
                for (int i = 0; stage != null && stage.IntercomStages != null && i < stage.IntercomStages.Count; i++)
                {
                    string id = stage.IntercomStages[i] != null ? stage.IntercomStages[i].Id : null;
                    if (!string.IsNullOrEmpty(id))
                        items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.RandomRouteTarget(stageIndex, intercomIndex, r, id), "Random -> " + id, "Set this random route target.", true, string.Equals(intercom.RandomizedNextIds[r], id, StringComparison.OrdinalIgnoreCase), "RN")));
                }
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.RandomRouteDelete(stageIndex, intercomIndex, r), "Remove Random Route", "Remove this randomized route.", true, false, "RM")));
            }
        }
        ...
        {
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(removal ? StoryAuthoringCommands.RemovalAdd(stageIndex, intercomIndex) : StoryAuthoringCommands.RewardAdd(stageIndex, intercomIndex), "Add " + title, "Add an item row.", true, false, "I+")));
            ...
            for (int e = 0; entries != null && e < entries.Count; e++)
            {
                ...
                for (int i = 0; i < max; i++)
                    items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(removal ? StoryAuthoringCommands.RemovalItem(stageIndex, intercomIndex, e, catalog[i].ItemId) : StoryAuthoringCommands.RewardItem(stageIndex, intercomIndex, e, catalog[i].ItemId), catalog[i].DisplayName, "Select this item.", true, entry != null && string.Equals(entry.ItemId, catalog[i].ItemId, StringComparison.OrdinalIgnoreCase), "IT", catalog[i].Detail, null, catalog[i].PreviewSprite)));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(removal ? StoryAuthoringCommands.RemovalQuantity(stageIndex, intercomIndex, e, 1) : StoryAuthoringCommands.RewardQuantity(stageIndex, intercomIndex, e, 1), "Qty +", "Increase quantity.", true, false, "+")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(removal ? StoryAuthoringCommands.RemovalQuantity(stageIndex, intercomIndex, e, -1) : StoryAuthoringCommands.RewardQuantity(stageIndex, intercomIndex, e, -1), "Qty -", "Decrease quantity.", true, false, "-")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(removal ? StoryAuthoringCommands.RemovalDelete(stageIndex, intercomIndex, e) : StoryAuthoringCommands.RewardDelete(stageIndex, intercomIndex, e), "Remove " + title, "Remove this item row.", true, false, "RM")));
            }
        }
        ...
        {
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.MilestoneAdd(stageIndex, intercomIndex), "Add Milestone", "Add a scenario milestone mutation.", true, false, "M+")));
            for (int i = 0; intercom.SetMilestones != null && i < intercom.SetMilestones.Count; i++)
            {
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.MilestoneName(stageIndex, intercomIndex, i, name + "_copy"), "Name " + name + "_copy", "Use the next milestone-name pattern.", true, false, "MN")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.MilestoneDelete(stageIndex, intercomIndex, i), "Remove Milestone", "Remove this milestone.", true, false, "RM")));
            }
        }
        ...
        private static void AddEndTypeActions(List<ScenarioAuthoringInspectorItem> items, int stageIndex, int intercomIndex, string current)
        {
            ...
            for (int i = 0; i < types.Length; i++)
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(StoryAuthoringCommands.EndType(stageIndex, intercomIndex, types[i]), "End " + types[i], "Set vanilla encounter outcome type.", true, string.Equals(current, types[i], StringComparison.OrdinalIgnoreCase), "END")));
        }
        ...
        private static void AddSuppressionCategoryAction(List<ScenarioAuthoringInspectorItem> items, ScenarioConversationSuppressionDefinition settings, string category, string label)
        {
            ...
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                StoryAuthoringCommands.SetConversationSuppressionCategory(category),
                label,
        ...
        private static void AddStoryCharacterChoices(List<ScenarioAuthoringInspectorItem> items, ScenarioDefinition definition, ScenarioConversationParticipantDefinition participant, int conversationIndex, int participantIndex)
        {
            items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                StoryAuthoringCommands.SetConversationParticipantStoryCharacter(conversationIndex, participantIndex, string.Empty),
                "Story None",
            ...
            for (int i = 0; definition != null && definition.ScenarioCharacters != null && i < definition.ScenarioCharacters.Count; i++)
            {
                ...
                if (string.IsNullOrEmpty(id))
                    continue;
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    StoryAuthoringCommands.SetConversationParticipantStoryCharacter(conversationIndex, participantIndex, id),
        ...
        private static void AddFallbackChoices(List<ScenarioAuthoringInspectorItem> items, ScenarioConversationParticipantDefinition participant, int conversationIndex, int participantIndex)
        {
            ...
            for (int i = 0; values != null && i < values.Length; i++)
            {
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    StoryAuthoringCommands.SetConversationParticipantFallback(conversationIndex, participantIndex, values[i]),
                    "Fallback " + SplitWords(values[i]),
        ...
        private static ScenarioAuthoringInspectorItem EditableProperty(string label, string value, ScenarioAuthoringCommand command, string hint)
        {
            ScenarioAuthoringInspectorItem item = ScenarioInspectorItemFactory.Property(label, Safe(value), hint);
            item.Editable = true;
            item.Action = ScenarioInspectorItemFactory.Action(command, "Edit", hint, true, false, "ED");
            return item;
        }
        ...
        private static string FormatParticipant(ScenarioDefinition definition, ScenarioConversationParticipantDefinition participant)
        {
            if (participant == null)
                return "Missing participant";
            List<string> parts = new List<string>();
            if (!string.IsNullOrEmpty(participant.StoryCharacterId))
                parts.Add("story character " + FormatCharacterLabel(definition, participant.StoryCharacterId));
            if (participant.ActorRef != null)
                parts.Add("cast member " + ScenarioCastMemberReferenceCatalog.ResolveDisplayName(definition, participant.ActorRef, true, true, "linked cast member"));
            parts.Add("fallback " + SplitWords(participant.Fallback.ToString()).ToLowerInvariant());
            parts.Add(participant.Required ? "required" : "optional");
            return string.Join(", ", parts.ToArray());
        }

        private static string ResolveConversationLine(ScenarioConversationLineDefinition line, int index)
        {
            return ScenarioAuthoringDisplayNameResolver.ShellRebuild.Resolve(
                line != null ? line.RawText : null,
                line != null ? line.TextKey : null,
                null,
                "Line " + (index + 1).ToString(CultureInfo.InvariantCulture)).Text;
        }
        ...
        private static string SplitWords(string value)
        {
            ...
            {
                if (i > 0 && char.IsUpper(value[i]) && char.IsLower(value[i - 1])) result.Add(' ');
                result.Add(value[i]);
            }
        ...
        private static string BuildOutgoingSummary(ScenarioFlowDefinition flow, ScenarioFlowStageDefinition stage)
        {
            ...
            return routes.Count > 0 ? string.Join(" Â· ", routes.ToArray()) : "No outgoing stage arrow - this stage stays active or ends here.";
        }
        ...
        private sealed class QuestSectionBuilder
        {
                ...
                int index)
            {
                ...
                sections.Add(BuildModeSection(idPart, index, triggerStarted));
                if (triggerStarted)
                    sections.Add(BuildTriggerSection(quest, idPart, index));
                else
                    sections.Add(BuildScheduleSection(quest, idPart, index));
                ...
                bool triggerStarted)
            {
                List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.ToggleQuestStartMode, index),
                    "Scheduled",
                ...
                int index)
            {
                ...
                List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestDay, index, -1),
                    "Day -",
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    ...
                    "D+")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestHour, index, -1),
                    "Hr -",
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    ...
                    "H+")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.StepQuestMinute, index, -15),
                    "Min -15",
                ...
                int index)
            {
                List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestTrigger, index, -1),
                    "< Prev",
                ...
                QuestDef libraryQuest)
            {
                List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestId, index, -1),
                    "< Prev id",
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    ...
                    "ID+")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.SyncQuestTitle, index),
                    "Sync Title",
                    ...
                    "NM")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.SyncQuestDescription, index),
                    "Sync Desc",
                    ...
                    "DS")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.CycleQuestCompletion, index, 1),
                    "Cycle Completion",
                ...
                QuestDef libraryQuest)
            {
                List<ScenarioAuthoringInspectorItem> items = new List<ScenarioAuthoringInspectorItem>();
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.SpawnQuestNow, index),
                    "Spawn Now",
                    ...
                    "SP")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.MoveQuest, index, -1),
                    "Move Up",
                ...
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    ...
                    "DN")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.DuplicateQuest, index),
                    "Duplicate",
                    ...
                    "CP")));
                items.Add(ScenarioInspectorItemFactory.ActionItem(ScenarioInspectorItemFactory.Action(
                    GameplayScheduleCommands.Quest(GameplayScheduleCommandKind.DeleteQuest, index),
                    "Remove",
        ...
        internal static class QuestAuthoringHelpers
        {
            ...
            public static string FormatQuestValidation(QuestDefinition quest, ScenarioDefinition definition)
            {
                ...
                if (definition != null
                    ...
                    && !ShelteredScenarioAuthoring.IndexDefinition(definition).HasTrigger(quest.StartTriggerId))
            ...
            public static List<string> BuildQuestWarnings(ScenarioDefinition definition)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    if (!string.IsNullOrEmpty(quest.StartTriggerId) && !ShelteredScenarioAuthoring.IndexDefinition(definition).HasTrigger(quest.StartTriggerId))
            ...
            {
                return ShelteredScenarioAuthoring.IndexDefinition(definition).HasCondition(conditionId);
            }
        }
    }
}
