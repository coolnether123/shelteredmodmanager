...
namespace ShelteredScenarioEditor.Presentation.UiKit.Layout{
    /// <summary>
    /// Pure rect-math primitives for laying out the inside of a window. Composes
    /// with <see cref="ShelteredScenarioEditor.Presentation.Authoring.Shell.ScenarioAuthoringShellLayout"/> rather
