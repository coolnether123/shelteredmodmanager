...
namespace ShelteredScenarioEditor.Presentation.UiKit
{
    /// <summary>
    ...
    internal sealed class ScenarioUiStyleSheet
    {
        ...
        private void Rebuild()
        {
            ...
            const int materialSize = ScenarioUiAtlasSkin.CornerTextureSize;
            const int materialCornerCut = ScenarioUiAtlasSkin.CornerRadiusPixels;
            Texture2D page = ProceduralTextureLibrary.MaterialSurface(MaterialSurfaceTier.Page, materialSize, materialSize, materialCornerCut, p.SurfacePage);
            Texture2D card = ProceduralTextureLibrary.MaterialSurface(MaterialSurfaceTier.RaisedCard, materialSize, materialSize, materialCornerCut, p.SurfaceCard);
            Texture2D cardHover = ProceduralTextureLibrary.MaterialSurface(MaterialSurfaceTier.RaisedCard, materialSize, materialSize, materialCornerCut, p.SurfaceCardHover);
            Texture2D cardSelected = ProceduralTextureLibrary.MaterialSurface(MaterialSurfaceTier.RaisedCard, materialSize, materialSize, materialCornerCut, p.SurfaceCardSelected);
            Texture2D inset = ProceduralTextureLibrary.MaterialSurface(MaterialSurfaceTier.RecessedInset, materialSize, materialSize, materialCornerCut, p.SurfaceInset);
            Texture2D chrome = _textures.GetCornerCut(p.SurfaceChrome);
            ...
            SearchField = BuildField(accentNeutralCorner, accentActiveCorner, palette.TextPrimary, m, padX, padY);
            ...
            ButtonEmphasized = BuildButton(gold, warning, pressed, p.TextOnAccent, p.TextPrimary, p.TextPrimary, m, padX, padY);
            ...
            TabActive = BuildButton(gold, pressed, pressed, p.TextOnAccent, p.TextPrimary, p.TextPrimary, m, padX, padY);
