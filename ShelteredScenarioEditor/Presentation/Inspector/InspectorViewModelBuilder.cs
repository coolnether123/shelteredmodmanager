...
namespace ShelteredScenarioEditor.Presentation.Inspector{
    internal sealed class InspectorViewModelBuilder
    {
            ...
            string stageLabel)
        {
            ...
            items.Add(ScenarioInspectorItemFactory.Property("Draft", ScenarioInspectorItemFactory.Safe(authoringSession != null ? authoringSession.DraftId : null)));
            items.Add(ScenarioInspectorItemFactory.Property("Scenario File", ScenarioInspectorItemFactory.Safe(authoringSession != null ? authoringSession.ScenarioFilePath : null)));
