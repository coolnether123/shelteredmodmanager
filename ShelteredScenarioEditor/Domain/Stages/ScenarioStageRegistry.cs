...
namespace ShelteredScenarioEditor.Domain.Stages{
    ...
    /// </summary>
    internal sealed class ScenarioStageRegistry
    {
        ...
        public ScenarioStageRegistry()
        {
            ...
            Register(new ScenarioStageDefinition(ScenarioStageKind.Test, "Test Console", 7, ScenarioStageKind.None, true, true, "Playtest, safe time controls, and live execution logs."));
            Register(new ScenarioStageDefinition(ScenarioStageKind.Publish, "Publish", 8, ScenarioStageKind.None, true, true, "Validate and create a local package for sharing."));
        }
