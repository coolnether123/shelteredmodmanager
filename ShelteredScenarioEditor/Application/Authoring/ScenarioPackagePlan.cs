...
namespace ShelteredScenarioEditor.Application.Authoring
{
    ...
    internal sealed class ScenarioPackagePlanner
    {
            ...
            ScenarioEditorSession editorSession)
        {
            ...
            AddGenerated(plan, ScenarioEditorDefinitionSerializer.DefaultFileName, Serialize(definition));
            ...
            if (includeReadme)
                AddGenerated(plan, ReadmeFileName, Encoding.UTF8.GetBytes(BuildReadme(definition, plan.RequiredMods, limitations, editorSession)));
            ...
            ScenarioEditorSession editorSession)
        {
            ...
            string honestyLine = _testChecklistService.BuildReadmeHonestyLine(editorSession);
            ...
            text.AppendLine("Copy this scenario folder into <Sheltered game>\\mods\\ModAPI\\User\\Scenarios, then reopen the scenario book. Restart the game if the catalog was already cached.");
