...
namespace ShelteredScenarioEditor.Application.Authoring.Templates
{
    ...
    /// catalog serializes these through ScenarioEditorDefinitionSerializer before use.
    /// </summary>
    internal static class ScenarioStarterTemplateBuilder
    {
        ...
        internal static ScenarioDefinition BuildSmallSurvivalChallenge()
        {
            ...
            ScenarioConditionRef victory = new ScenarioConditionRef
            {
                Id = "survive-ten-days",
                Kind = ScenarioConditionKind.SurviveDays,
                Quantity = 10,
                Time = new ScenarioScheduleTime { Hour = 8, Minute = 0 }
            };
        ...
        private static ScenarioDefinition CreateDefinition(string id, string title, string description)
        {
            ScenarioDefinition definition = new ScenarioDefinition
            {
                ...
                BaseFamilyChoice = ShelteredAPI.Scenarios.Definitions.ScenarioBaseFamilyChoices.KeepCurrentCast,
