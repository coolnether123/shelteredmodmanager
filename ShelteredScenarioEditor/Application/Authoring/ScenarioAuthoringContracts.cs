...
namespace ShelteredScenarioEditor.Application.Authoring{
    internal interface IScenarioAuthoringBackend
    {
        ...
        bool ExecuteCommand(ScenarioAuthoringCommand command);
        ScenarioCommandExecutionResult ExecuteCommandWithResult(ScenarioAuthoringCommand command);
        bool UpdateWindowFrame(string windowId, float x, float y, float width, float height, bool persist);
        bool BringWindowToFront(string windowId);
        void Refresh();
    }
    ...
    internal static class ScenarioAuthoringActionIds
    {
        ...
        public const string ActionBackdropSelectPrefix = "backdrop.select.";
        ...
        public static bool IsBuildPlacementStart(string actionId)
        {
            return string.Equals(actionId, ActionBuildStructureRoom, StringComparison.Ordinal)
                || string.Equals(actionId, ActionBuildStructureLadder, StringComparison.Ordinal)
                || string.Equals(actionId, ActionBuildStructureLight, StringComparison.Ordinal)
                || (!string.IsNullOrEmpty(actionId) && actionId.StartsWith(ActionBuildObjectPlacePrefix, StringComparison.Ordinal));
        }
    ...
    internal struct ScenarioCommandExecutionResult
    {
        ...
        public static ScenarioCommandExecutionResult Success(string automationId, bool changed, string statusMessage)
        {
            return new ScenarioCommandExecutionResult
            {
                Available = true,
        ...
        public static ScenarioCommandExecutionResult Failure(string automationId, string reason, string statusMessage)
        {
        ...
        public static ScenarioCommandExecutionResult Unavailable(string automationId, string reason)
        {
    ...
    internal sealed class ScenarioAuthoringState
    {
        ...
        public AssetBrowserSelection AssetBrowserSelection { get; set; }
        ...
        public ScenarioAuthoringState Copy()
        {
            ScenarioAuthoringState copy = new ScenarioAuthoringState
            {
                ...
                AssetBrowserSelection = AssetBrowserSelection,
    ...
    internal sealed class ScenarioAuthoringSettingsSnapshot
    {
        ...
        {
            get { return GetBool("debug.show_advanced_details", false); }
        }
    ...
    internal sealed class ScenarioAuthoringTourViewModel
    {
        ...
        public string Title { get; set; }
        public string Body { get; set; }
        public ScenarioAuthoringCommand TargetCommand { get; set; }
    ...
    internal sealed class ScenarioSurvivorColorRowViewModel
    {
        ...
        public ScenarioAuthoringInspectorAction PreviousAction { get; set; }
        public ScenarioAuthoringInspectorAction NextAction { get; set; }
        public CharacterEditorCommand OpenColorPickerCommand { get; set; }
        public CharacterEditorCommand ApplyColorCommand { get; set; }
    }
