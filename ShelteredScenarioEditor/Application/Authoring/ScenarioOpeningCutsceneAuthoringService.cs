...
namespace ShelteredScenarioEditor.Application.Authoring
{
    internal sealed class ScenarioOpeningCutsceneAuthoringService
    {
        ...
        internal ScenarioOpeningCutsceneAuthoringService(
        ...
        internal void UpdateAuthoringIntroCutsceneFallback()
        {
            ...
            _pauseService.EnsurePaused("Opening cutscene skipped from authoring.");
            _statusPort.Publish("Opening cutscene skipped; editor restored.");
        }
        ...
        private static Cutscene FindIntroCutscene(CutsceneManager manager)
        {
            ...
            {
                string message;
                ScenarioEditorSeamGuard.Try<List<Cutscene>>(
        ...
        private PreviewContext BeginPreview(ScenarioAuthoringState state, CutsceneManager manager, Cutscene cutscene)
        {
            ...
            _pauseService.ReleasePauseForRunningSimulation("Opening cutscene preview started.");
        ...
        private void RestorePreview(PreviewContext preview, string statusMessage)
        {
            if (preview == null)
                return;
            ...
            _pauseService.EnsurePaused("Opening cutscene preview finished.");
