...
namespace ShelteredScenarioEditor.Application.Authoring{
    ...
    internal sealed class ScenarioEditorSession
    {
        public ScenarioEditorSession()
        {
            ...
            EditorState = new ScenarioEditorState();
        ...
        public ScenarioEditorState EditorState { get; set; }
        public ScenarioAuthorTestChecklist AuthorTestChecklist
        {
            get
            {
                EnsureEditorState();
                return EditorState.AuthorTestChecklist;
            }
            set
            {
                EnsureEditorState();
                EditorState.AuthorTestChecklist = value ?? new ScenarioAuthorTestChecklist();
            }
        }
