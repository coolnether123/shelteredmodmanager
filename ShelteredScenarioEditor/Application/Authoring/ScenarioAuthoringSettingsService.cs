...
namespace ShelteredScenarioEditor.Application.Authoring{
    internal sealed class ScenarioAuthoringSettingsService
    {
        ...
        public ScenarioAuthoringSettingsService()
        {
            ...
            RegisterFloat("shell.panel_opacity", "Visuals", "Modal Scrim Opacity", "Darkness behind modal editor surfaces. Pages and panels remain fully opaque.", "0.82", 0.55f, 1f, 0.05f);
