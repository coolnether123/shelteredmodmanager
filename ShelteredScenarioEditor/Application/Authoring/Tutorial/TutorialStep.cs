...
namespace ShelteredScenarioEditor.Application.Authoring.Tutorial{
    internal sealed class TutorialStep
    {
        public TutorialStep(
            ...
            ScenarioAuthoringCommand targetCommand)
        {
            Index = index;
            Id = id;
            Title = title;
        ...
        public string TargetActionId { get { return TargetCommand != null ? TargetCommand.AutomationId : null; } }
        public ScenarioAuthoringCommand TargetCommand { get; private set; }
    }
}
