...
namespace ShelteredScenarioEditor.Application.Map{
    internal sealed class ScenarioMapDraftService
    {
            ...
            out bool wasExisting)
        {
            ...
            if (ShelteredAPI.Scenarios.Public.ShelteredScenarioAuthoring.IsKnownMapIconId(selection.IconId))
            ...
            int brushSize)
        {
            ...
            SetProperty(patch.Properties, "authoring.renderMode",
                string.Equals(terrainId, ShelteredAPI.Scenarios.Public.ShelteredScenarioAuthoring.GeneratedBlendTerrainId, StringComparison.OrdinalIgnoreCase)
                    ? "generated-blend"
                    : "manual");
