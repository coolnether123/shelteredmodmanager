...
namespace ShelteredScenarioEditor.Application.Timeline
{
    ...
    internal static class ScenarioTimelinePresetService
    {
        ...
        public static bool TryCreate(ScenarioEditorSession session, string presetId, out string message)
        {
            message = null;
            if (session == null || session.WorkingDefinition == null || string.IsNullOrEmpty(presetId))
                return false;
