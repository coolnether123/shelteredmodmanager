...
namespace ShelteredScenarioEditor.Diagnostics
{
    ...
    internal static class ScenarioStarterTemplateVerification
    {
        ...
        private static void VerifyTemplate(ScenarioStarterTemplate template, ScenarioValidationResult result)
        {
            ...
            try
            {
                definition = new ScenarioEditorDefinitionSerializer().FromXml(template.BundledXml);
            }
            catch (Exception ex)
            {
            ...
            ScenarioValidationResult validation = ShelteredScenarioAuthoring.ValidateDefinition(definition, null);
            ...
            Assert(ShelteredScenarioAuthoring.CanStartPlay(definition, out playtestReason),
