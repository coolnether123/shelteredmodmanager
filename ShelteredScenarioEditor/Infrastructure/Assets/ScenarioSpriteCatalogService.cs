...
using ShelteredScenarioEditor.Domain.Assets;
using System;
...
namespace ShelteredScenarioEditor.Infrastructure.Assets{
    internal sealed class ScenarioSpriteCatalogService
    {
        ...
        private readonly ScenarioEditorSpriteRuntimeResolver _resolver;
        private readonly ScenarioEditorSpriteAssetService _assetResolver;
        ...
        internal ScenarioSpriteCatalogService(ScenarioEditorSpriteRuntimeResolver resolver, ScenarioEditorSpriteAssetService assetResolver)
        {
            _resolver = resolver;
        ...
        public SpriteCatalog GetCatalog(ScenarioEditorSession session, ScenarioAuthoringTarget target, string scenarioFilePath)
        {
            ...
            if (!_resolver.TryResolve(
                    ...
                    out resolvedTarget)
                || resolvedTarget == null
                || resolvedTarget.CurrentSprite == null)
                return null;

            string targetPath = resolvedTarget.TargetPath ?? target.TransformPath;
            string currentSpriteKey = ShelteredScenarioRuntime.CreateRuntimeSpriteKey(resolvedTarget.CurrentSprite);
        ...
        private static SpriteCatalog BuildCatalog(
            ...
            ScenarioEditorSpriteAssetService assetResolver)
        {
            ...
            bool allowWeatherEffectPalette = ScenarioWeatherEffectSpriteCatalogService.IsWeatherEffectTarget(authoringTarget);
            ...
            ScenarioLoadedSpriteReference[] loadedSprites = ScenarioLoadedSpriteCatalog.Capture();
            for (int i = 0; i < loadedSprites.Length; i++)
            {
                ScenarioLoadedSpriteReference loaded = loadedSprites[i];
                if (loaded == null
                    || loaded.Sprite == null
        ...
        private static bool IsEnvironmentCandidate(
            ScenarioLoadedSpriteReference loaded,
