...
namespace ShelteredScenarioEditor.Infrastructure.Assets{
    internal sealed class ScenarioSpriteFamilyMatcher
    {
        ...
        public FamilyProfile DescribeTarget(ScenarioAuthoringTarget authoringTarget, ScenarioRuntimeSpriteTarget resolvedTarget)
        {
            ...
            GameObject forcedRoot)
        {
            ...
            if (objBase != null)
            {
                ...
                AddNameTokens(profile, ShelteredScenarioRuntime.GetTransformPath(objBase.transform));
            }
            else
            {
                ...
                AddNameTokens(profile, ShelteredScenarioRuntime.GetTransformPath(transform));
            }
