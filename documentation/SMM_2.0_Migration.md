...
- A mod appearing in the manager does not mean that a 1.2.2 or 1.3 build is compatible.
...
7. Keep the old SMM and mod package available until you have verified the saves you want to keep.

## Expected compatibility warning

When SMM 2.0 sees a mod built against an older API line, it should warn:

`This mod was built for the older SMM API line. SMM 2.0 moved Sheltered APIs into ShelteredAPI.dll; use a 2.0 version of the mod before loading saves you want to keep.`
