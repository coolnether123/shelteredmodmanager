...
$sources = @(
    ...
    'Manager\Core\Models\NexusAccountStatus.cs',
    'Manager\Core\Models\NexusModReference.cs',
    'Manager\Core\Models\NexusRemoteMod.cs',
    'Manager\Core\Models\NexusRemoteModFile.cs',
    'Manager\Core\Models\NexusUploadDraft.cs',
    'Manager\Core\Services\NexusReleaseClassifier.cs',
    'Manager\Core\Services\NexusModsService.cs',
