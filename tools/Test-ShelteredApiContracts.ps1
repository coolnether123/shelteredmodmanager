...
Assert-Contains "modal button centers" $nguiModalPrimitives 'background\.pivot = UIWidget\.Pivot\.Center;.*label\.pivot = UIWidget\.Pivot\.Center;' "shared modal buttons must treat their supplied transform position as the visual center across NGUI versions."
