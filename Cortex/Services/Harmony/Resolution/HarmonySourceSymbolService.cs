...
namespace Cortex.Services.Harmony.Resolution
{
    internal sealed class HarmonySourceSymbolService
    {
        ...
        public bool TryBuildLookupHint(CortexShellState state, string documentPath, int absolutePosition, string symbolText, out HarmonyMethodLookupHint hint)
        {
            hint = null;
        ...
        public string GetDocumentText(CortexShellState state, string documentPath)
        {
