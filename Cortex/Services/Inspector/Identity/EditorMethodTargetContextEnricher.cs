...
{
    internal interface IEditorMethodTargetContextEnricher
    {
        void EnsureSymbolContextRequest(CortexShellState state, EditorCommandTarget target);
        void Enrich(EditorCommandTarget target, DocumentSession session, CortexShellState state);
    }

    internal sealed class EditorMethodTargetContextEnricher : IEditorMethodTargetContextEnricher
    {
        ...
        public EditorMethodTargetContextEnricher(IEditorContextService contextService)
        {
        ...
        public void EnsureSymbolContextRequest(CortexShellState state, EditorCommandTarget target)
        {
            ...
            _semanticRequestService.QueueRequest(state, target, SemanticRequestKind.SymbolContext);
        }
