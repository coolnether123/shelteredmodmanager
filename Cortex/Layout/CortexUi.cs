...
namespace Cortex
{
    internal static class CortexUi
    {
        private static readonly IWorkbenchUiSurface _defaultSurface = new ImGuiWorkbenchUiSurface();

        public static IWorkbenchUiSurface DefaultSurface
        {
            get { return _defaultSurface; }
        }

        private sealed class ImGuiWorkbenchUiSurface : IWorkbenchUiSurface
        {
            ...
            public bool DrawNavigationGroupHeader(string title, bool isActive, bool isExpanded)
            {
                ...
                GUI.backgroundColor = isActive
                    ? CortexIdeLayout.Blend(CortexIdeLayout.GetAccentColor(), CortexIdeLayout.GetHeaderColor(), 0.3f)
                    : CortexIdeLayout.Blend(CortexIdeLayout.GetSurfaceColor(), CortexIdeLayout.GetHeaderColor(), 0.72f);
                GUI.contentColor = isActive ? Color.white : CortexIdeLayout.GetTextColor();
            ...
            public void DrawCollapsedNavigationItem(string title, float indent)
            {
                ...
                GUILayout.EndHorizontal();
                DrawHorizontalRule(CortexIdeLayout.Blend(CortexIdeLayout.GetBorderColor(), CortexIdeLayout.GetTextColor(), 0.3f), 1f);
                GUILayout.Space(4f);
            }
            ...
            public void DrawSectionHeader(string title, string description)
            {
                ...
                DrawHorizontalRule(CortexIdeLayout.Blend(CortexIdeLayout.GetBorderColor(), CortexIdeLayout.GetTextColor(), 0.34f), 1f);
            ...
            public void DrawSectionPanel(string title, Action drawBody)
            {
                ...
                GUILayout.BeginHorizontal();
                DrawAccentBar(2f, 56f, CortexIdeLayout.Blend(CortexIdeLayout.GetAccentColor(), CortexIdeLayout.GetBorderColor(), 0.4f));
                GUILayout.Space(14f);
                GUILayout.BeginVertical(GUILayout.ExpandWidth(true));
                if (drawBody != null)
                {
            ...
            public void DrawPopupMenuPanel(float width, Action drawBody)
            {
                ...
                DrawHorizontalRule(CortexIdeLayout.Blend(CortexIdeLayout.GetAccentColor(), CortexIdeLayout.GetBorderColor(), 0.32f), 2f);
                GUILayout.Space(4f);
                if (drawBody != null)
                {
                    drawBody();
            ...
            public void BeginPropertyRow()
            {
                ...
                DrawAccentBar(2f, 44f, CortexIdeLayout.Blend(CortexIdeLayout.GetAccentColor(), CortexIdeLayout.GetBorderColor(), 0.45f));
                GUILayout.Space(14f);
                GUILayout.BeginVertical(GUILayout.ExpandWidth(true));
            }
