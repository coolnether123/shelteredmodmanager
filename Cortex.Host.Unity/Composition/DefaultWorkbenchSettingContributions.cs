...
namespace Cortex.Host.Unity.Composition
{
    internal sealed class DefaultWorkbenchSettingContributions
    {
        public void Register(WorkbenchPluginContext context)
        {
            ...
            context.RegisterSetting(nameof(CortexSettings.WorkspaceRootPath), "Workspace Scan Root", "Tell Cortex where to scan for editable workspace sources.", "Workspace", string.Empty, SettingValueKind.String, 0, SettingEditorKind.Path, "D:\\Projects\\MyWorkspace", string.Empty, new[] { "workspace", "root", "projects" }, new SettingChoiceOption[0], false);
            context.RegisterSetting(nameof(CortexSettings.ModsRootPath), "Loaded Mods Root", "Points to the live mod folder used for source mapping and discovery.", "Workspace", string.Empty, SettingValueKind.String, 10, SettingEditorKind.Path, "D:\\Games\\Sheltered\\SMM\\mods", string.Empty, new[] { "mods", "loaded mods", "live mods" }, new SettingChoiceOption[0], false);
            context.RegisterSetting(nameof(CortexSettings.ManagedAssemblyRootPath), "Game Managed DLLs", "Used to locate assemblies for reference browsing and decompilation.", "Workspace", string.Empty, SettingValueKind.String, 20, SettingEditorKind.Path, "D:\\Games\\Sheltered\\Sheltered_Data\\Managed", string.Empty, new[] { "managed", "assemblies", "dlls" }, new SettingChoiceOption[0], false);
