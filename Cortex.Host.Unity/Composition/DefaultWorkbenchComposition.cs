...
namespace Cortex.Host.Unity.Composition
{
    internal static class DefaultWorkbenchComposition
    {
            ...
            string rendererDisplayName)
        {
            ...
            RegisterSetting(contributionRegistry, nameof(CortexSettings.EnableCompletionAugmentation), "Enable AI Completion", "Enable the modular completion augmentation pipeline. Cortex remains in control of which document text and related snippets are supplied to providers.", "AI", "false", SettingValueKind.Boolean, 0);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.CompletionAugmentationProviderId), "Active Provider", "Provider id used by the augmentation pipeline. Built-in ids are tabby, ollama, and openrouter.", "AI", CompletionAugmentationProviderIds.Tabby, SettingValueKind.String, 10);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.CompletionAugmentationAdditionalInstructions), "Additional Instructions", "Optional extra completion instructions appended to provider defaults when supported. Tabby ignores this because Cortex cannot override Tabby's internal prompt template through its completion API.", "AI", string.Empty, SettingValueKind.String, 20);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.CompletionAugmentationReplaceProviderPrompt), "Replace Provider Prompt", "When enabled, providers that support prompt steering use the additional instructions instead of their built-in default prompt text. Tabby ignores this setting.", "AI", "false", SettingValueKind.Boolean, 30);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.CompletionAugmentationIncludeOpenDocumentSnippets), "Include Open Doc Snippets", "Allow Cortex to attach snippets from other open source documents. Providers only receive snippets Cortex explicitly selected here and do not crawl your workspace on their own.", "AI", "true", SettingValueKind.Boolean, 40);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.CompletionAugmentationSnippetDocumentLimit), "Snippet Document Limit", "Maximum number of other open source documents Cortex may sample for provider context.", "AI", "3", SettingValueKind.Integer, 50);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.CompletionAugmentationSnippetCharacterLimit), "Snippet Character Limit", "Maximum characters sampled from each related document snippet.", "AI", "800", SettingValueKind.Integer, 60);

            RegisterSetting(contributionRegistry, nameof(CortexSettings.EnableTabbyCompletion), "Enable Tabby Provider", "Allow the Tabby provider to be selected. Leave Tabby Server URL blank to use the bundled local Cortex.Tabby.Server host backed by Ollama.", "AI - Tabby", "false", SettingValueKind.Boolean, 0);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.TabbyServerUrl), "Tabby Server URL", "Optional explicit Tabby-compatible endpoint, for example http://localhost:8080. Leave blank to let Cortex launch the bundled local Tabby host.", "AI - Tabby", string.Empty, SettingValueKind.String, 10);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.TabbyApiToken), "Tabby API Token", "Optional bearer token used when the Tabby server requires authorization.", "AI - Tabby", string.Empty, SettingValueKind.String, 20);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.TabbyRequestTimeoutMs), "Tabby Timeout (ms)", "Maximum time allowed for Tabby completion requests.", "AI - Tabby", "8000", SettingValueKind.Integer, 30);

            RegisterSetting(contributionRegistry, nameof(CortexSettings.OllamaServerUrl), "Ollama Server URL", "Base URL for the Ollama server, for example http://localhost:11434.", "AI - Ollama", "http://localhost:11434", SettingValueKind.String, 0);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OllamaApiToken), "Ollama API Token", "Optional bearer token for Ollama when the endpoint sits behind authenticated routing.", "AI - Ollama", string.Empty, SettingValueKind.String, 10);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OllamaModel), "Ollama Model", "Model name used for direct Ollama completion requests.", "AI - Ollama", string.Empty, SettingValueKind.String, 20);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OllamaSystemPrompt), "Ollama System Prompt", "Default system prompt used for direct Ollama completions. Additional instructions append to this unless Replace Provider Prompt is enabled.", "AI - Ollama", CompletionAugmentationPromptDefaults.OllamaSystemPrompt, SettingValueKind.String, 30);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OllamaRequestTimeoutMs), "Ollama Timeout (ms)", "Maximum time allowed for direct Ollama completion requests.", "AI - Ollama", "8000", SettingValueKind.Integer, 40);

            RegisterSetting(contributionRegistry, nameof(CortexSettings.OpenRouterBaseUrl), "OpenRouter Base URL", "Base URL for OpenRouter, normally https://openrouter.ai/api/v1.", "AI - OpenRouter", "https://openrouter.ai/api/v1", SettingValueKind.String, 0);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OpenRouterApiKey), "OpenRouter API Key", "API key used for direct OpenRouter completion requests.", "AI - OpenRouter", string.Empty, SettingValueKind.String, 10);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OpenRouterModel), "OpenRouter Model", "Model name used for direct OpenRouter completion requests. Use a model that supports completion/insertion style requests.", "AI - OpenRouter", string.Empty, SettingValueKind.String, 20);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OpenRouterPromptPreamble), "OpenRouter Prompt Preamble", "Default prompt preamble used ahead of the current document prefix. Additional instructions append to this unless Replace Provider Prompt is enabled.", "AI - OpenRouter", CompletionAugmentationPromptDefaults.OpenRouterPromptPreamble, SettingValueKind.String, 30);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OpenRouterAppUrl), "OpenRouter App URL", "Optional HTTP-Referer value sent to OpenRouter.", "AI - OpenRouter", string.Empty, SettingValueKind.String, 40);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OpenRouterAppTitle), "OpenRouter App Title", "Optional X-Title value sent to OpenRouter.", "AI - OpenRouter", "Cortex", SettingValueKind.String, 50);
            RegisterSetting(contributionRegistry, nameof(CortexSettings.OpenRouterRequestTimeoutMs), "OpenRouter Timeout (ms)", "Maximum time allowed for direct OpenRouter completion requests.", "AI - OpenRouter", "10000", SettingValueKind.Integer, 60);
