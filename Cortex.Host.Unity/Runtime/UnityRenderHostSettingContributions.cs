    ...
    public static class UnityRenderHostSettingContributions
    {
            ...
            int sortOrder)
        {
            ...
            return new SettingContribution
            {
                ...
                DefaultValue = UnityRenderHostSettings.DearImguiRenderHostId,
                ...
                Keywords = new[] { "presentation mode", "render host", "renderer", "imgui", "dear imgui", "desktop host", "external host" },
