...
{
    /// <summary>
    /// Centralized touch gesture bridge for UI scrolling and drag-style input.
    /// Keeps touch logic in one place so UI and input patches stay DRY.
    /// </summary>
    public static class TouchInputBridge
    {
        ...
        /// <summary>
        /// Returns wheel-equivalent vertical scroll from touch drag.
        /// Positive scroll means "up", negative means "down" (same convention as wheel code paths).
        /// </summary>
        public static bool TryGetTouchScroll(float minUiX, float maxUiX, out float scroll)
        {
            ...
            // Finger up should advance down-content (wheel-like down), so invert sign.
